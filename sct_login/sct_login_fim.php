...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____sct_login"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____sct_login"]);
   }
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sct_login']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['sct_login']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['sct_login']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sct_login']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['sct_login']['sc_outra_jan'])
   {
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['sct_login']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['sct_login']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   ...
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sct_login']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['sct_login']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['sct_login']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['sct_login']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['sct_login']['db_changed'])
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['sct_login']['lig_iframe_modal']))
               {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['sct_login']['lig_iframe_modal'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['sct_login']['lig_iframe_modal']);
               }
               else
               {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['sct_login']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['sct_login']['db_changed'])
           {
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['sct_login']['lig_iframe_modal']))
       {
           $Save_modal = $_SESSION['sc_session'][$script_case_init]['sct_login']['lig_iframe_modal'];
           nm_limpa_arr_session();
           $_SESSION['sc_session'][$script_case_init]['sct_login']['lig_iframe_modal'] = $Save_modal;
       }
       else
       {
           nm_limpa_arr_session();
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['sct_login']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['sct_login']['embutida_filho'] as $ind => $sc_init)
          {
