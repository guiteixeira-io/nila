<?php  
  ...
  session_start() ;
  class sct_login_form_teste
  {
   function sct_login_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sct_login/img";
...
?> 
<br> 
<B><FONT SIZE="4">sct_login</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sct_login"> 
</form> 
...
<?php
  ...
  $frm_teste = new sct_login_form_teste();
  $frm_teste->sct_login_teste();
?>
