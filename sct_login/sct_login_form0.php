...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>sct_login/sct_login_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("sct_login_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('sct_login_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['link_info']['remove_border']) {
...
<?php
 include_once("sct_login_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['sct_login'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['sct_login'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['where_filter']))
       {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['Lookup_remember_me'][] = '1'; ?>
...
<input type="hidden" name="new_user_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_new_user('sct_form_add_users', '_self')"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<input type="hidden" name="retrieve_pswd_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_retrieve_pswd('sct_retrieve_pswd', '_self')"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['facebook']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['facebook']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['facebook']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['facebook']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['facebook'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bfacebook", "scBtnFn_sys_auth_facebook()", "scBtnFn_sys_auth_facebook()", "bfacebook_b", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['twitter']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['twitter']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['twitter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['twitter']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['twitter'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "btwitter", "scBtnFn_sys_auth_twitter()", "scBtnFn_sys_auth_twitter()", "btwitter_b", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['btn_label']['ok'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("sct_login");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("sct_login");
 parent.scAjaxDetailHeight("sct_login", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_auth_facebook() {
		if ($("#bfacebook_b.sc-unique-btn-1").length && $("#bfacebook_b.sc-unique-btn-1").is(":visible")) {
		    if ($("#bfacebook_b.sc-unique-btn-1").hasClass("disabled")) {
		        return;
		    }
			sc_facebook_auth()
			 return;
	...
	function scBtnFn_sys_auth_twitter() {
		if ($("#btwitter_b.sc-unique-btn-2").length && $("#btwitter_b.sc-unique-btn-2").is(":visible")) {
		    if ($("#btwitter_b.sc-unique-btn-2").hasClass("disabled")) {
		        return;
		    }
			sc_twitter_auth()
			 return;
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['sct_login']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
