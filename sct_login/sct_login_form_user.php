...
<html lang="en">
    <head>
        ...
        <title>Sign In</title>
        <link rel="stylesheet" type="text/css" href="../_lib/libraries/grp/nila/login/css/login.css">
        <link rel="stylesheet" type="text/css" href="../_lib/libraries/grp/nila/libs/css/styles.css">
        <style>
...
?>
        ...
        <script type="text/javascript" src="../_lib/libraries/grp/nila/libs/js/error.js"></script>
    </body>
</html>