<?php  
  ...
  session_start() ;
  class sct_change_pswd_form_teste
  {
   function sct_change_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sct_change_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">sct_change_pswd</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sct_change_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new sct_change_pswd_form_teste();
  $frm_teste->sct_change_pswd_teste();
?>
