  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cdt_course" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_cdt_course_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_id(var_id, var_script_case_init, do_ajax_cdt_course_validate_id_cb);
  } // do_ajax_cdt_course_validate_id

  function do_ajax_cdt_course_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_id_cb

  // ---------- Validate pai
  function do_ajax_cdt_course_validate_pai()
  {
    var nomeCampo_pai = "pai";
    var var_pai = scAjaxGetFieldText(nomeCampo_pai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_pai(var_pai, var_script_case_init, do_ajax_cdt_course_validate_pai_cb);
  } // do_ajax_cdt_course_validate_pai

  function do_ajax_cdt_course_validate_pai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_pai_cb

  // ---------- Validate icone
  function do_ajax_cdt_course_validate_icone()
  {
    var nomeCampo_icone = "icone";
    var var_icone = scAjaxGetFieldText(nomeCampo_icone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_icone(var_icone, var_script_case_init, do_ajax_cdt_course_validate_icone_cb);
  } // do_ajax_cdt_course_validate_icone

  function do_ajax_cdt_course_validate_icone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icone";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_icone_cb

  // ---------- Validate descricao
  function do_ajax_cdt_course_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_descricao(var_descricao, var_script_case_init, do_ajax_cdt_course_validate_descricao_cb);
  } // do_ajax_cdt_course_validate_descricao

  function do_ajax_cdt_course_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_descricao_cb

  // ---------- Validate link
  function do_ajax_cdt_course_validate_link()
  {
    var nomeCampo_link = "link";
    var var_link = scAjaxGetFieldText(nomeCampo_link);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_link(var_link, var_script_case_init, do_ajax_cdt_course_validate_link_cb);
  } // do_ajax_cdt_course_validate_link

  function do_ajax_cdt_course_validate_link_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "link";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_link_cb

  // ---------- Validate ordenacao
  function do_ajax_cdt_course_validate_ordenacao()
  {
    var nomeCampo_ordenacao = "ordenacao";
    var var_ordenacao = scAjaxGetFieldText(nomeCampo_ordenacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_ordenacao(var_ordenacao, var_script_case_init, do_ajax_cdt_course_validate_ordenacao_cb);
  } // do_ajax_cdt_course_validate_ordenacao

  function do_ajax_cdt_course_validate_ordenacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_ordenacao_cb

  // ---------- Validate sc_field_0
  function do_ajax_cdt_course_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_cdt_course_validate_sc_field_0_cb);
  } // do_ajax_cdt_course_validate_sc_field_0

  function do_ajax_cdt_course_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_sc_field_0_cb

  // ---------- Validate planoeconomico
  function do_ajax_cdt_course_validate_planoeconomico()
  {
    var nomeCampo_planoeconomico = "planoeconomico";
    var var_planoeconomico = scAjaxGetFieldText(nomeCampo_planoeconomico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_planoeconomico(var_planoeconomico, var_script_case_init, do_ajax_cdt_course_validate_planoeconomico_cb);
  } // do_ajax_cdt_course_validate_planoeconomico

  function do_ajax_cdt_course_validate_planoeconomico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_planoeconomico_cb

  // ---------- Validate planostandart
  function do_ajax_cdt_course_validate_planostandart()
  {
    var nomeCampo_planostandart = "planostandart";
    var var_planostandart = scAjaxGetFieldText(nomeCampo_planostandart);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_planostandart(var_planostandart, var_script_case_init, do_ajax_cdt_course_validate_planostandart_cb);
  } // do_ajax_cdt_course_validate_planostandart

  function do_ajax_cdt_course_validate_planostandart_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_planostandart_cb

  // ---------- Validate planopremium
  function do_ajax_cdt_course_validate_planopremium()
  {
    var nomeCampo_planopremium = "planopremium";
    var var_planopremium = scAjaxGetFieldText(nomeCampo_planopremium);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_planopremium(var_planopremium, var_script_case_init, do_ajax_cdt_course_validate_planopremium_cb);
  } // do_ajax_cdt_course_validate_planopremium

  function do_ajax_cdt_course_validate_planopremium_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_planopremium_cb

  // ---------- Validate modulo
  function do_ajax_cdt_course_validate_modulo()
  {
    var nomeCampo_modulo = "modulo";
    var var_modulo = scAjaxGetFieldText(nomeCampo_modulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_course_validate_modulo(var_modulo, var_script_case_init, do_ajax_cdt_course_validate_modulo_cb);
  } // do_ajax_cdt_course_validate_modulo

  function do_ajax_cdt_course_validate_modulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_course_validate_modulo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cdt_course_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cdt_course_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_cdt_course_submit_form(var_id, var_pai, var_icone, var_descricao, var_link, var_ordenacao, var_sc_field_0, var_planoeconomico, var_planostandart, var_planopremium, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cdt_course_submit_form_cb);
  } // do_ajax_cdt_course_submit_form

  function do_ajax_cdt_course_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cdt_course_submit_form_cb_after_alert);
  } // do_ajax_cdt_course_submit_form_cb
  function do_ajax_cdt_course_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cdt_course_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["cdt_subject"] = "off";

  function do_ajax_cdt_course_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cdt_course_navigate_form, function() {});
    } else {
      perform_ajax_cdt_course_navigate_form();
    }
  }

  function perform_ajax_cdt_course_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["cdt_subject"] = "on";
    x_ajax_cdt_course_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cdt_course_navigate_form_cb);
  } // do_ajax_cdt_course_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_course']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cdt_course_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_cdt_subject"] && "nmsc_iframe_liga_cdt_subject" != scMasterDetailIframe["nmsc_iframe_liga_cdt_subject"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_cdt_subject"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_cdt_subject').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_cdt_subject').style.height = "1";
        document.getElementById('nmsc_iframe_liga_cdt_subject').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cdt_course_navigate_form_cb_after_alert);
  } // do_ajax_cdt_course_navigate_form_cb
  function do_ajax_cdt_course_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_cdt_course_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cdt_course_navigate_form_cb_after_alert

  function sc_hide_cdt_course_form()
  {
  ...
  {
    if ("off" == scStatusDetail["cdt_subject"])
    {
      return true;
    }
    return false;
