<?php  
  ...
  session_start() ;
  class cdt_course_form_teste
  {
   function cdt_course_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cdt_course/img";
...
?> 
<br> 
<B><FONT SIZE="4">cdt_course</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cdt_course"> 
</form> 
...
<?php
  ...
  $frm_teste = new cdt_course_form_teste();
  $frm_teste->cdt_course_teste();
?>
