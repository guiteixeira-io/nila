<?php
@session_start() ;
$_SESSION['scriptcase']['rlt_usuario']['sc_process_barr'] = true;
require_once('../rlt_usuario/index.php');
unset($_SESSION['scriptcase']['rlt_usuario']['sc_process_barr']);
$ExportCtrl = new rlt_usuario_export_control;
$ExportCtrl->Export_barr();

class rlt_usuario_export_control
{
