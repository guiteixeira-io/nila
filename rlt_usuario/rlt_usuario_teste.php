<?php  
  ...
  session_start() ;
  class rlt_usuario_form_teste
  {
  function rlt_usuario_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">rlt_usuario</FONT></B> 
<br> 
<br> 
...
<input type=submit value="rlt_usuario"> 
</form> 
...
<?php
  ...
  $frm_teste = new rlt_usuario_form_teste();
  $frm_teste->rlt_usuario_teste();
?>
