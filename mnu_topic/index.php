...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['mnu_topic']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['mnu_topic']['glo_nm_conexao']        = "nila";
    $_SESSION['scriptcase']['mnu_topic']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['mnu_topic']['glo_nm_usa_grupo']      = "S";
...
class mnu_topic_class
{
 ...
 function mnu_topic_menu()
 {
    global $mnu_topic_menuData, $nm_data_fixa;
...
$path_img_old   = $str_root . $path_link . "mnu_topic/img";
...
include_once(dirname(__FILE__) . "/mnu_topic_erro.class.php"); 
$this->Erro = new mnu_topic_erro();
$str_path = substr($_SESSION['scriptcase']['mnu_topic']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['mnu_topic']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['mnu_topic']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$mnu_topic_menuData         = array();
$mnu_topic_menuData['path'] = array();
$mnu_topic_menuData['url']  = array();
$mnu_topic_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $mnu_topic_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $mnu_topic_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $mnu_topic_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $mnu_topic_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$mnu_topic_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$mnu_topic_menuData['url']['web']   = str_replace("\\", '/', $mnu_topic_menuData['url']['web']);
$mnu_topic_menuData['path']['root'] = substr($mnu_topic_menuData['path']['sys'],  0, -1 * strlen($mnu_topic_menuData['url']['web']));
$mnu_topic_menuData['path']['app']  = substr($mnu_topic_menuData['path']['sys'],  0, strrpos($mnu_topic_menuData['path']['sys'],  '/'));
$mnu_topic_menuData['path']['link'] = substr($mnu_topic_menuData['path']['app'],  0, strrpos($mnu_topic_menuData['path']['app'],  '/'));
$mnu_topic_menuData['path']['link'] = substr($mnu_topic_menuData['path']['link'], 0, strrpos($mnu_topic_menuData['path']['link'], '/')) . '/';
$mnu_topic_menuData['path']['app'] .= '/';
$mnu_topic_menuData['url']['app']   = substr($mnu_topic_menuData['url']['web'],  0, strrpos($mnu_topic_menuData['url']['web'],  '/'));
$mnu_topic_menuData['url']['link']  = substr($mnu_topic_menuData['url']['app'],  0, strrpos($mnu_topic_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['mnu_topic']['glo_nm_usa_grupo'] == "S")
{
    $mnu_topic_menuData['url']['link']  = substr($mnu_topic_menuData['url']['link'], 0, strrpos($mnu_topic_menuData['url']['link'], '/'));
}
$mnu_topic_menuData['url']['link']  .= '/';
$mnu_topic_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['mnu_topic']['sc_apl_link'] = $mnu_topic_menuData['url']['link'];
...
include_once("mnu_topic_toolbar.php");
...
if ($_SESSION['scriptcase']['mnu_topic']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "mnu_topic";
     $_SESSION['scriptcase']['menu_apls']['mnu_topic'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['mnu_topic']['glo_nm_conexao']) && $_SESSION['scriptcase']['mnu_topic']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_topic']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_topic']['glo_nm_perfil']) && $_SESSION['scriptcase']['mnu_topic']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_topic']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_topic']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['mnu_topic']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['mnu_topic']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['mnu_topic']['init']))
{
    $_SESSION['sc_session'][1]['mnu_topic']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['mnu_topic']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['mnu_topic']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_mnu_topic'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_mnu_topic'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_mnu_topic'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['mnu_topic']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['mnu_topic']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'mnu_topic'))
{
    $_SESSION['sc_session'][1]['mnu_topic']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_mnu_topic'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$mnu_topic_menuData['iframe'] = TRUE;
...
unset($_SESSION['scriptcase']['sc_def_menu']["mnu_topic"]);
...
{
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"] = array();
}
$sql='SELECT
    id,
    pai,
...
if($this->rs  !== false) {
	if(!empty($this->rs->fields[0])) {
		while(!$this->rs->EOF) {
			...
			if (isset($_SESSION['scriptcase']['sc_def_menu']["mnu_topic"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['pai']            = $pai;
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['label']          = $descricao;
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['link']           = $link;
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['icon']           = $icone;
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['hint']           = $descricao;
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['target']         = $target;
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['name']           = $link;
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['display']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['display_position']= "";
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['icon_fa']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['icon_color']      = "";
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['icon_color_hover']= "";
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['icon_color_disabled']= "";
    $Temp_url = $link;
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "mnu_topic";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['sc_init'] = $this->Gera_sc_init($link);
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "mnu_topic" . "&script_case_init=" . $this->Gera_sc_init($link);
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["mnu_topic"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["mnu_topic"][$id]['url'] = $Temp_url;
}
$this->rs->MoveNext();
		}
		$this->rs->Close();
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_mnu_topic'];
...
$mnu_topic_menuData['data'] = array();

if (isset($_SESSION['scriptcase']['sc_def_menu']['mnu_topic']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['mnu_topic']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'mnu_topic');
    $mnu_topic_menuData['data'] = $str_menu_usu;
}
if (is_file("mnu_topic_help.txt"))
{
    $Arq_WebHelp = file("mnu_topic_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $mnu_topic_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->mnu_topic_target('_blank') . "",
                    'sc_id'    => "item_Help",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['mnu_topic']) && !empty($_SESSION['scriptcase']['sc_menu_del']['mnu_topic']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($mnu_topic_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['mnu_topic']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($mnu_topic_menuData['data'][$i_menu]);
       }
    ...
    $mnu_topic_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['mnu_topic']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['mnu_topic']))
{
    $disable_menu = false;
    foreach ($mnu_topic_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['mnu_topic']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $mnu_topic_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['mnu_topic']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $mnu_topic_menuData['height'] = '30px';
}
...
<script type="text/javascript" src="mnu_topic_message.js"></script>
        ...
        }function openMenuItem(str_id)
{
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_mnu_topic').length)
        $('#iframe_mnu_topic')[0].contentWindow.focus();
  }
}
</script>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $mnu_topic_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->mnu_topic_escreveMenu($mnu_topic_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_mnu_topic" name="mnu_topic_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "mnu_topic_pag_ini.php"); ?>"></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Controle de Target */
function mnu_topic_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function mnu_topic_target($str_target)
{
    global $mnu_topic_menuData;
    ...
    elseif ($mnu_topic_menuData['iframe'])
    {
        return 'mnu_topic_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $mnu_topic_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "mnu_topic_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_topic_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_topic']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "mnu_topic_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_topic_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_topic']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->mnu_topic_target( $arr_item['target']) : "_self"; 
           }
...
$contr_mnu_topic = new mnu_topic_class;
$contr_mnu_topic->mnu_topic_menu();
