<?php
@session_start() ;
$_SESSION['scriptcase']['rpt_workspace']['sc_process_barr'] = true;
require_once('../rpt_workspace/index.php');
unset($_SESSION['scriptcase']['rpt_workspace']['sc_process_barr']);
$ExportCtrl = new rpt_workspace_export_control;
$ExportCtrl->Export_barr();

class rpt_workspace_export_control
{
