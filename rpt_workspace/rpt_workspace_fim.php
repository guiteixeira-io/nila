...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____rpt_workspace"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____rpt_workspace"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_workspace']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['rpt_workspace']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_workspace']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['rpt_workspace']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['rpt_workspace']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['rpt_workspace']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['rpt_workspace']['embutida_filho'] as $ind => $sc_init)
          {
