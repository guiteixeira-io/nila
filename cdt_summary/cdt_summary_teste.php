<?php  
  ...
  session_start() ;
  class cdt_summary_form_teste
  {
   function cdt_summary_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cdt_summary/img";
...
?> 
<br> 
<B><FONT SIZE="4">cdt_summary</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cdt_summary"> 
</form> 
...
<?php
  ...
  $frm_teste = new cdt_summary_form_teste();
  $frm_teste->cdt_summary_teste();
?>
