<?php  
  ...
  session_start() ;
  class sct_form_sec_groups_form_teste
  {
   function sct_form_sec_groups_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sct_form_sec_groups/img";
...
?> 
<br> 
<B><FONT SIZE="4">sct_form_sec_groups</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sct_form_sec_groups"> 
</form> 
...
<?php
  ...
  $frm_teste = new sct_form_sec_groups_form_teste();
  $frm_teste->sct_form_sec_groups_teste();
?>
