<?php  
  ...
  session_start() ;
  class rpt_systemMessages_studyspace_form_teste
  {
  function rpt_systemMessages_studyspace_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">rpt_systemMessages_studyspace</FONT></B> 
<br> 
<br> 
...
<input type=submit value="rpt_systemMessages_studyspace"> 
</form> 
...
<?php
  ...
  $frm_teste = new rpt_systemMessages_studyspace_form_teste();
  $frm_teste->rpt_systemMessages_studyspace_teste();
?>
