...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____rpt_systemMessages_studyspace"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____rpt_systemMessages_studyspace"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>rpt_systemMessages_studyspace</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['embutida_filho'] as $ind => $sc_init)
          {
