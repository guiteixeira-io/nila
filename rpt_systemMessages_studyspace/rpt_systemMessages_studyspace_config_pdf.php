...
*/
    ...
    $SC_cod_proj = "nila";
    $SC_apl_proc = "rpt_systemMessages_studyspace";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['rpt_systemMessages_studyspace']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['rpt_systemMessages_studyspace']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['rpt_systemMessages_studyspace']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['rpt_systemMessages_studyspace']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['rpt_systemMessages_studyspace']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
