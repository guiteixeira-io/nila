<?php
@session_start() ;
$_SESSION['scriptcase']['rpt_studyspace']['sc_process_barr'] = true;
require_once('../rpt_studyspace/index.php');
unset($_SESSION['scriptcase']['rpt_studyspace']['sc_process_barr']);
$ExportCtrl = new rpt_studyspace_export_control;
$ExportCtrl->Export_barr();

class rpt_studyspace_export_control
{
