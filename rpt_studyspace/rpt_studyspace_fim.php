...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____rpt_studyspace"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____rpt_studyspace"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_studyspace']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['rpt_studyspace']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_studyspace']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['rpt_studyspace']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['rpt_studyspace']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['rpt_studyspace']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['rpt_studyspace']['embutida_filho'] as $ind => $sc_init)
          {
