<?php  
  ...
  session_start() ;
  class rpt_studyspace_form_teste
  {
  function rpt_studyspace_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">rpt_studyspace</FONT></B> 
<br> 
<br> 
...
<input type=submit value="rpt_studyspace"> 
</form> 
<script language=javascript> 
 document.FCons.usr_login.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new rpt_studyspace_form_teste();
  $frm_teste->rpt_studyspace_teste();
?>
