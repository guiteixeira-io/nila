...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____rpt_course_price"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____rpt_course_price"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_course_price']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['rpt_course_price']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_course_price']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['rpt_course_price']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['rpt_course_price']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['rpt_course_price']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['rpt_course_price']['embutida_filho'] as $ind => $sc_init)
          {
