<?php
@session_start() ;
$_SESSION['scriptcase']['rpt_course_price']['sc_process_barr'] = true;
require_once('../rpt_course_price/index.php');
unset($_SESSION['scriptcase']['rpt_course_price']['sc_process_barr']);
$ExportCtrl = new rpt_course_price_export_control;
$ExportCtrl->Export_barr();

class rpt_course_price_export_control
{
