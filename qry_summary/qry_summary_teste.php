<?php  
  ...
  session_start() ;
  class qry_summary_form_teste
  {
  function qry_summary_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">qry_summary</FONT></B> 
<br> 
<br> 
...
<input type=submit value="qry_summary"> 
</form> 
...
<?php
  ...
  $frm_teste = new qry_summary_form_teste();
  $frm_teste->qry_summary_teste();
?>
