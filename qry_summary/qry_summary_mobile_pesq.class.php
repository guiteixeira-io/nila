...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "aula";$Nm_numeric[] = "";$Nm_numeric[] = "id";$Nm_numeric[] = "aula";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_aula_cond" name="aula_cond" onChange="nm_campos_between(document.getElementById('id_vis_aula'), this, 'aula')">
      ...
      <br><span id="id_hide_aula"  <?php echo $str_hide_aula?>><INPUT  type="text" id="SC_aula" name="aula" value="<?php echo NM_encode_input($aula) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_conteudo_cond" name="conteudo_cond" onChange="nm_campos_between(document.getElementById('id_vis_conteudo'), this, 'conteudo')">
      ...
      <br><span id="id_hide_conteudo"  <?php echo $str_hide_conteudo?>><INPUT  type="text" id="SC_conteudo" name="conteudo" value="<?php echo NM_encode_input($conteudo) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
