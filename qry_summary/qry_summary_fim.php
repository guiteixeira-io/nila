...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____qry_summary"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____qry_summary"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cdt_summary'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_summary']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['qry_summary']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_summary']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['qry_summary']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['qry_summary']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['qry_summary']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['qry_summary']['embutida_filho'] as $ind => $sc_init)
          {
