<?php
@session_start() ;
$_SESSION['scriptcase']['qry_summary']['sc_process_barr'] = true;
require_once('../qry_summary/index.php');
unset($_SESSION['scriptcase']['qry_summary']['sc_process_barr']);
$ExportCtrl = new qry_summary_export_control;
$ExportCtrl->Export_barr();

class qry_summary_export_control
{
