<?php  
  ...
  session_start() ;
  class sct_sync_apps_form_teste
  {
   function sct_sync_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sct_sync_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">sct_sync_apps</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sct_sync_apps"> 
</form> 
...
<?php
  ...
  $frm_teste = new sct_sync_apps_form_teste();
  $frm_teste->sct_sync_apps_teste();
?>
