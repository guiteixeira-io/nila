<?php
include_once('mnu_supplies_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['mnu_supplies']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['mnu_supplies']['glo_nm_conexao']        = "";
    $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class mnu_supplies_class
{
  var $Db;
 ...
 function mnu_supplies_menu()
 {
    global $mnu_supplies_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['mnu_supplies']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "mnu_supplies/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('mnu_supplies');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/mnu_supplies_erro.php");
}
include_once(dirname(__FILE__) . "/mnu_supplies_erro.class.php"); 
$this->Erro = new mnu_supplies_erro();
$str_path = substr($_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['mnu_supplies']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$mnu_supplies_menuData         = array();
$mnu_supplies_menuData['path'] = array();
$mnu_supplies_menuData['url']  = array();
$mnu_supplies_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $mnu_supplies_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $mnu_supplies_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $mnu_supplies_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $mnu_supplies_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$mnu_supplies_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$mnu_supplies_menuData['url']['web']   = str_replace("\\", '/', $mnu_supplies_menuData['url']['web']);
$mnu_supplies_menuData['path']['root'] = substr($mnu_supplies_menuData['path']['sys'],  0, -1 * strlen($mnu_supplies_menuData['url']['web']));
$mnu_supplies_menuData['path']['app']  = substr($mnu_supplies_menuData['path']['sys'],  0, strrpos($mnu_supplies_menuData['path']['sys'],  '/'));
$mnu_supplies_menuData['path']['link'] = substr($mnu_supplies_menuData['path']['app'],  0, strrpos($mnu_supplies_menuData['path']['app'],  '/'));
$mnu_supplies_menuData['path']['link'] = substr($mnu_supplies_menuData['path']['link'], 0, strrpos($mnu_supplies_menuData['path']['link'], '/')) . '/';
$mnu_supplies_menuData['path']['app'] .= '/';
$mnu_supplies_menuData['url']['app']   = substr($mnu_supplies_menuData['url']['web'],  0, strrpos($mnu_supplies_menuData['url']['web'],  '/'));
$mnu_supplies_menuData['url']['link']  = substr($mnu_supplies_menuData['url']['app'],  0, strrpos($mnu_supplies_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo'] == "S")
{
    $mnu_supplies_menuData['url']['link']  = substr($mnu_supplies_menuData['url']['link'], 0, strrpos($mnu_supplies_menuData['url']['link'], '/'));
}
$mnu_supplies_menuData['url']['link']  .= '/';
$mnu_supplies_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['mnu_supplies']['sc_apl_link'] = $mnu_supplies_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['mnu_supplies']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['mnu_supplies']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['mnu_supplies']['actual_lang']) || $_SESSION['scriptcase']['mnu_supplies']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['mnu_supplies']['actual_lang'] = $this->str_lang;
...
include_once("mnu_supplies_toolbar.php");
...
if ($_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "mnu_supplies";
     $_SESSION['scriptcase']['menu_apls']['mnu_supplies'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['mnu_supplies']['glo_nm_conexao']) && $_SESSION['scriptcase']['mnu_supplies']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_supplies']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_supplies']['glo_nm_perfil']) && $_SESSION['scriptcase']['mnu_supplies']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_supplies']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_supplies']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['mnu_supplies']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['mnu_supplies']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['mnu_supplies']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['mnu_supplies']['init']))
{
    $_SESSION['sc_session'][1]['mnu_supplies']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['mnu_supplies']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_mnu_supplies'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_mnu_supplies'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_mnu_supplies'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'mnu_supplies'))
{
    $_SESSION['sc_session'][1]['mnu_supplies']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_mnu_supplies'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$mnu_supplies_menuData['iframe'] = TRUE;
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_mnu_supplies'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['qry_course']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['qry_course']) == "on")
{
    $mnu_supplies_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|mnu_supplies_form_php.php?sc_item_menu=item_1&sc_apl_menu=qry_course&sc_apl_link=" . urlencode($mnu_supplies_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->mnu_supplies_target('_self') . "|" . "\n";
}
else
{
    $mnu_supplies_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['qry_class']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['qry_class']) == "on")
{
    $mnu_supplies_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "|mnu_supplies_form_php.php?sc_item_menu=item_2&sc_apl_menu=qry_class&sc_apl_link=" . urlencode($mnu_supplies_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->mnu_supplies_target('_self') . "|" . "\n";
}
else
{
    $mnu_supplies_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
...
$mnu_supplies_menuData['data'] = array();
$str_disabled = "N";
$str_link = "mnu_supplies_form_php.php?sc_item_menu=item_1&sc_apl_menu=qry_course&sc_apl_link=" . urlencode($mnu_supplies_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['qry_course']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['qry_course']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_supplies_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->mnu_supplies_target('_self') . "\"",
        'sc_id'    => "item_1",
...
$str_disabled = "N";
$str_link = "mnu_supplies_form_php.php?sc_item_menu=item_2&sc_apl_menu=qry_class&sc_apl_link=" . urlencode($mnu_supplies_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['qry_class']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['qry_class']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['mnu_supplies']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['mnu_supplies']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'mnu_supplies');
    $mnu_supplies_menuData['data'] = $str_menu_usu;
}
if (is_file("mnu_supplies_help.txt"))
{
    $Arq_WebHelp = file("mnu_supplies_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $mnu_supplies_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->mnu_supplies_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['mnu_supplies']) && !empty($_SESSION['scriptcase']['sc_menu_del']['mnu_supplies']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($mnu_supplies_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['mnu_supplies']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($mnu_supplies_menuData['data'][$i_menu]);
       }
    ...
    $mnu_supplies_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['mnu_supplies']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['mnu_supplies']))
{
    $disable_menu = false;
    foreach ($mnu_supplies_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['mnu_supplies']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $mnu_supplies_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($mnu_supplies_menuData['iframe'])
{
    $mnu_supplies_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $mnu_supplies_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="mnu_supplies_message.js"></script>
...
Iframe_atual = "mnu_supplies_iframe";
...
{
  if (str_id != "iframe_mnu_supplies")
  {
      str_id        = str_id.replace("mnu_supplies_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_mnu_supplies').length)
        $('#iframe_mnu_supplies')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $mnu_supplies_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->mnu_supplies_escreveMenu($mnu_supplies_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $mnu_supplies_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_mnu_supplies" name="mnu_supplies_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "mnu_supplies_pag_ini.php"); ?>"></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Controle de Target */
function mnu_supplies_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function mnu_supplies_target($str_target)
{
    global $mnu_supplies_menuData;
    ...
    elseif ($mnu_supplies_menuData['iframe'])
    {
        return 'mnu_supplies_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $mnu_supplies_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "mnu_supplies_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_supplies_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "mnu_supplies_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_supplies_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->mnu_supplies_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['mnu_supplies']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_supplies']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "mnu_supplies") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['mnu_supplies']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_nila'])) {
            $_SESSION['scriptcase']['mnu_supplies']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_nila'];
        }
    }
}
...
$contr_mnu_supplies = new mnu_supplies_class;
$contr_mnu_supplies->mnu_supplies_menu();
