<?php
@session_start() ;
$_SESSION['scriptcase']['qry_classExam']['sc_process_barr'] = true;
require_once('../qry_classExam/index.php');
unset($_SESSION['scriptcase']['qry_classExam']['sc_process_barr']);
$ExportCtrl = new qry_classExam_export_control;
$ExportCtrl->Export_barr();

class qry_classExam_export_control
{
