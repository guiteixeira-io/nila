...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "class";$Nm_numeric[] = "id";$Nm_numeric[] = "class";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_class_cond" name="class_cond" onChange="nm_campos_between(document.getElementById('id_vis_class'), this, 'class')">
      ...
      <br><span id="id_hide_class"  <?php echo $str_hide_class?>><INPUT  type="text" id="SC_class" name="class" value="<?php echo NM_encode_input($class) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_link_cond" name="link_cond" onChange="nm_campos_between(document.getElementById('id_vis_link'), this, 'link')">
      ...
      <br><span id="id_hide_link"  <?php echo $str_hide_link?>><?php
      if ($link != "")
      {
      $link_look = (is_string($link) ? substr($this->Db->qstr($link), 1, -1) : $link); 
      $nmgp_def_dados = array(); 
