...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____qry_classExam"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____qry_classExam"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cdt_classExam'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_classExam']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['qry_classExam']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_classExam']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['qry_classExam']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['qry_classExam']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['qry_classExam']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['qry_classExam']['embutida_filho'] as $ind => $sc_init)
          {
