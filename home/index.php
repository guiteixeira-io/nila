...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['home']['glo_nm_conexao']        = "nila";
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/img_menu_sobre_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/img_menu_sobre_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['img_menu_sobre']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['img_menu_sobre'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/img_menu_plane_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/img_menu_plane_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['img_menu_plane']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['img_menu_plane'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/img_menu_catalog_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/img_menu_catalog_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['img_menu_catalog']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['img_menu_catalog'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/img_menu_contact_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/img_menu_contact_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['img_menu_contact']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['img_menu_contact'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
    ...
    <tr id="id_toolbar">
        <td class="scMenuHTableCss" align="center" style="margin:0px; padding:0px;" <?php echo $col_span; ?>>
            ...
            <?php
                ...
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_1", "home_form_php.php?sc_item_menu=btn_1&sc_apl_menu=img_menu&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "home_form_php.php?sc_item_menu=btn_1&sc_apl_menu=img_menu&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "btn_1", "", "Home", "", "absmiddle", "", "0px", $this->path_botoes, "", "Home", "", "", "", "only_img", "text_right", "1", "" . $this->home_target('_self') . "", "", "", "", "home", "");
                }

                if ($this->nmgp_botoes['btn_9'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_9", "home_form_php.php?sc_item_menu=btn_9&sc_apl_menu=img_menu_sobre&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "home_form_php.php?sc_item_menu=btn_9&sc_apl_menu=img_menu_sobre&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "btn_9", "", "Quienes somos", "", "absmiddle", "", "0px", $this->path_botoes, "", "Quienes somos", "", "", "", "only_text", "text_right", "1", "" . $this->home_target('_self') . "", "", "", "", "home", "");
                }

                if ($this->nmgp_botoes['btn_10'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_10", "home_form_php.php?sc_item_menu=btn_10&sc_apl_menu=img_menu_plane&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "home_form_php.php?sc_item_menu=btn_10&sc_apl_menu=img_menu_plane&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "btn_10", "", "Nuestros planes", "", "absmiddle", "", "0px", $this->path_botoes, "", "Nuestros planes", "", "", "", "only_text", "text_right", "1", "" . $this->home_target('_self') . "", "", "", "", "home", "");
                }

                if ($this->nmgp_botoes['btn_2'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_2", "home_form_php.php?sc_item_menu=btn_2&sc_apl_menu=img_menu_catalog&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "home_form_php.php?sc_item_menu=btn_2&sc_apl_menu=img_menu_catalog&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "btn_2", "", "Cursadas", "", "absmiddle", "", "0px", $this->path_botoes, "", "Cursadas", "", "", "", "only_text", "text_right", "1", "" . $this->home_target('_self') . "", "", "", "", "home", "");
                }

                if ($this->nmgp_botoes['btn_11'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_11", "home_form_php.php?sc_item_menu=btn_11&sc_apl_menu=img_menu_contact&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "home_form_php.php?sc_item_menu=btn_11&sc_apl_menu=img_menu_contact&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "btn_11", "", "Hable con nosotros", "", "absmiddle", "", "0px", $this->path_botoes, "", "Hable con nosotros", "", "", "", "only_text", "text_right", "1", "" . $this->home_target('_self') . "", "", "", "", "home", "");
                }

                if ($this->nmgp_botoes['btn_5'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_5", "home_form_php.php?sc_item_menu=btn_5&sc_apl_menu=sct_login&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "home_form_php.php?sc_item_menu=btn_5&sc_apl_menu=sct_login&sc_apl_link=" . urlencode($home_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['home']['glo_nm_usa_grupo'] . "", "btn_5", "", "Ya soy estudiante", "", "absmiddle", "", "0px", $this->path_botoes, "", "Ya soy estudiante", "", "", "", "only_text", "text_right", "1", "" . $this->home_target('_parent') . "", "", "", "", "home", "");
                }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "home") {
        ...
        if (isset($_COOKIE['sc_actual_lang_nila'])) {
            $_SESSION['scriptcase']['home']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_nila'];
        }
    }
}
