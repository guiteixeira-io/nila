<?php
@session_start() ;
$_SESSION['scriptcase']['sct_grid_sec_users']['sc_process_barr'] = true;
require_once('../sct_grid_sec_users/index.php');
unset($_SESSION['scriptcase']['sct_grid_sec_users']['sc_process_barr']);
$ExportCtrl = new sct_grid_sec_users_export_control;
$ExportCtrl->Export_barr();

class sct_grid_sec_users_export_control
{
