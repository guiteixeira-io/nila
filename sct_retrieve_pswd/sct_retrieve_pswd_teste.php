<?php  
  ...
  session_start() ;
  class sct_retrieve_pswd_form_teste
  {
   function sct_retrieve_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sct_retrieve_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">sct_retrieve_pswd</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sct_retrieve_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new sct_retrieve_pswd_form_teste();
  $frm_teste->sct_retrieve_pswd_teste();
?>
