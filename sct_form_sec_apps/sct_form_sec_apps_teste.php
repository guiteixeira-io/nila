<?php  
  ...
  session_start() ;
  class sct_form_sec_apps_form_teste
  {
   function sct_form_sec_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sct_form_sec_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">sct_form_sec_apps</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sct_form_sec_apps"> 
</form> 
...
<?php
  ...
  $frm_teste = new sct_form_sec_apps_form_teste();
  $frm_teste->sct_form_sec_apps_teste();
?>
