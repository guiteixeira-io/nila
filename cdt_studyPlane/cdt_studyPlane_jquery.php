...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_cdt_studyPlane_id_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_cdt_studyPlane_id_onchange(this, iSeqRow) })
                                .bind('focus', function() { sc_cdt_studyPlane_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_cdt_studyPlane_name_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_cdt_studyPlane_name_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_cdt_studyPlane_name_onfocus(this, iSeqRow) });
  $('#id_sc_field_description' + iSeqRow).bind('blur', function() { sc_cdt_studyPlane_description_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_cdt_studyPlane_description_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_cdt_studyPlane_description_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_cdt_studyPlane_id_onblur(oThis, iSeqRow) {
  do_ajax_cdt_studyPlane_validate_id();
  scCssBlur(oThis);
}

function sc_cdt_studyPlane_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_studyPlane_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_cdt_studyPlane_name_onblur(oThis, iSeqRow) {
  do_ajax_cdt_studyPlane_validate_name();
  scCssBlur(oThis);
}

function sc_cdt_studyPlane_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_studyPlane_name_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_cdt_studyPlane_description_onblur(oThis, iSeqRow) {
  do_ajax_cdt_studyPlane_validate_description();
  scCssBlur(oThis);
}

function sc_cdt_studyPlane_description_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_studyPlane_description_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_cdt_studyPlane_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'cdt_studyPlane')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
