<?php  
  ...
  session_start() ;
  class cdt_studyPlane_form_teste
  {
   function cdt_studyPlane_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cdt_studyPlane/img";
...
?> 
<br> 
<B><FONT SIZE="4">cdt_studyPlane</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cdt_studyPlane"> 
</form> 
...
<?php
  ...
  $frm_teste = new cdt_studyPlane_form_teste();
  $frm_teste->cdt_studyPlane_teste();
?>
