<?php  
  ...
  session_start() ;
  class dsb_workspace_form_teste
  {
   function dsb_workspace_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "dsb_workspace/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'dsb_workspace')
  {
...
?> 
<br> 
<B><FONT SIZE="4">dsb_workspace</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="dsb_workspace"> 
</form> 
...
<?php
  ...
  $frm_teste = new dsb_workspace_form_teste();
  $frm_teste->dsb_workspace_teste();
?>
