...
include_once('dsb_studyspace_session.php');
@ini_set('session.cookie_httponly', 1);
@ini_set('session.use_only_cookies', 1);
@ini_set('session.cookie_secure', 0);
@session_start();

$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_perfil']          = "";
$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_prod']       = "/scriptcase/prod";
$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imagens']    = "/scriptcase/file/img";
$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_doc']        = "";
$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao']         = "nila";
...
//check prod
if(empty($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_dsb_studyspace($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "dsb_studyspace") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_nila'])) {
            $_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_nila'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_dsb_studyspace($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['dsb_studyspace']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['dsb_studyspace']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$dsb_studyspace_control = new dsb_studyspace_control();
$dsb_studyspace_control->control();

class dsb_studyspace_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_studyspace'])) {
            $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "dsb_studyspace";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        $this->nm_grupo        = "nila";
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/dsb_studyspace';
        ...
        if (isset($_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['dsb_studyspace']['actual_lang']) || $_SESSION['scriptcase']['dsb_studyspace']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['dsb_studyspace']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['redir'])) {
...
';
            ...
            if ($_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['dsb_studyspace']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['dsb_studyspace']['session_timeout']);
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao']) && $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_perfil']) && $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dsb_studyspace']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['dsb_studyspace']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['dsb_studyspace']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['SC_sep_date1'];
      }
// 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
          ...
          echo $str_message;
          if (!$_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['dsb_studyspace']['sc_outra_jan'] != 'dsb_studyspace')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao'], $this->root . $this->path_prod, 'nila', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dsb_studyspace']['glo_nm_conexao'], $this->root . $this->path_prod, 'nila', 1, $this->force_db_utf8);
    }
    else {
...
class dsb_studyspace_control {
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new dsb_studyspace_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['dsb_studyspace'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['dsb_studyspace'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['dsb_studyspace'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['dsb_studyspace']['dbifrm_widget1'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dsb_studyspace']['dbifrm_widget2'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dsb_studyspace']['dbifrm_widget3'] = rand(2, 10000);
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="dsb_studyspace_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['dsb_studyspace'] as $sIframe => $iSCInit) {
?>
...
} // dsb_studyspace_control

function nm_limpa_str_dsb_studyspace(&$str)
{
}
