<?php  
  ...
  session_start() ;
  class dsb_studyspace_form_teste
  {
   function dsb_studyspace_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "dsb_studyspace/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'dsb_studyspace')
  {
...
?> 
<br> 
<B><FONT SIZE="4">dsb_studyspace</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="dsb_studyspace"> 
</form> 
...
<?php
  ...
  $frm_teste = new dsb_studyspace_form_teste();
  $frm_teste->dsb_studyspace_teste();
?>
