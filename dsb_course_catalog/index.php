...
include_once('dsb_course_catalog_session.php');
@ini_set('session.cookie_httponly', 1);
@ini_set('session.use_only_cookies', 1);
@ini_set('session.cookie_secure', 0);
@session_start();

$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_perfil']          = "";
$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_prod']       = "/scriptcase/prod";
$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imagens']    = "/scriptcase/file/img";
$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_doc']        = "";
$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao']         = "nila";
...
//check prod
if(empty($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_dsb_course_catalog($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "dsb_course_catalog") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_nila'])) {
            $_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_nila'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_dsb_course_catalog($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['dsb_course_catalog']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['dsb_course_catalog']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$dsb_course_catalog_control = new dsb_course_catalog_control();
$dsb_course_catalog_control->control();

class dsb_course_catalog_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog'])) {
            $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "dsb_course_catalog";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        $this->nm_grupo        = "nila";
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/dsb_course_catalog';
        ...
        if (isset($_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['dsb_course_catalog']['actual_lang']) || $_SESSION['scriptcase']['dsb_course_catalog']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['dsb_course_catalog']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['redir'])) {
...
';
            ...
            if ($_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['dsb_course_catalog']['session_timeout']);
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao']) && $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_perfil']) && $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dsb_course_catalog']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['dsb_course_catalog']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['SC_sep_date1'];
      }
// 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
          ...
          echo $str_message;
          if (!$_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['dsb_course_catalog']['sc_outra_jan'] != 'dsb_course_catalog')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao'], $this->root . $this->path_prod, 'nila', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dsb_course_catalog']['glo_nm_conexao'], $this->root . $this->path_prod, 'nila', 1, $this->force_db_utf8);
    }
    else {
...
} // dsb_course_catalog_ini

class dsb_course_catalog_control {
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new dsb_course_catalog_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['dsb_course_catalog'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['dsb_course_catalog'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['dsb_course_catalog'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['dsb_course_catalog']['dbifrm_widget1'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dsb_course_catalog']['dbifrm_widget5'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dsb_course_catalog']['dbifrm_widget6'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dsb_course_catalog']['dbifrm_widget8'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dsb_course_catalog']['dbifrm_widget9'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dsb_course_catalog']['dbifrm_widget12'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['dsb_course_catalog'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['dsb_course_catalog']['rpt_course_name'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dsb_course_catalog']['rpt_course_price'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dsb_course_catalog']['img_menu'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="dsb_course_catalog_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['dsb_course_catalog'] as $sIframe => $iSCInit) {
?>
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="0" data-gs-width="4" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">Nome</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('rpt_course_name'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dsb_course_catalog"]["dbifrm_widget1"] ?>&under_dashboard=1&dashboard_app=dsb_course_catalog&own_widget=dbifrm_widget1&compact_mode=0&remove_margin=1&remove_border=1"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="6" data-gs-width="6" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">Preço</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-1"><iframe id="id-iframe-1" name="dbifrm_widget5" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('rpt_course_price'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dsb_course_catalog"]["dbifrm_widget5"] ?>&under_dashboard=1&dashboard_app=dsb_course_catalog&own_widget=dbifrm_widget5&compact_mode=0&remove_margin=1&remove_border=1"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="3" data-gs-width="2" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-2">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-2">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('2');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Modulos" /></a>
                            <h3 class="scContainerTitle">Modulos</h3>
                ...
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="3" data-gs-width="2" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-3">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-3">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">Disciplinas</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget8' style="height: 100%" id="id-div-iframe-3"><?php echo $this->getIndexContent_widget8(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="6" data-gs-width="2" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-4">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-4">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">Aulas</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget9' style="height: 100%" id="id-div-iframe-4"><?php echo $this->getIndexContent_widget9(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="8" data-gs-y="0" data-gs-width="4" data-gs-height="6"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-5">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-5">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">Imagem</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-5"><iframe id="id-iframe-5" name="dbifrm_widget12" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('img_menu'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dsb_course_catalog"]["dbifrm_widget12"] ?>&under_dashboard=1&dashboard_app=dsb_course_catalog&own_widget=dbifrm_widget12&compact_mode=0&remove_margin=1&remove_border=1"></iframe></div>
                    </div>
                </div></div>
...
<?php
    ...
    function getIndexContentData_widget6() {
        ...
        {
            $sSql = "SELECT COUNT(id) FROM modulo";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget6">Modulos</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget8() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(id) FROM aula";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"id\") FROM aula";
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget8">Disciplinas</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget9() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(id) FROM topico";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"id\") FROM topico";
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget9">Clases</span></div>
        <div class="clearfix"><span style="clear: both" class="{$this->indexData['index_class']} {$this->indexData['index_class']}Size {$this->indexData['index_class']}_widget9 {$this->indexData['index_class']}Size_widget9">{$this->indexData['new_metric_formatted']}</span></div>
    </div>
</div>
...
IDXHTML;
    ...
    function formatIndexMetric_widget9($value) {
        ...
        nmgp_Form_Num_Val($value, $this->Ini->field_config['widget9_metric']['symbol_grp'], $this->Ini->field_config['widget9_metric']['symbol_dec'], '0', 'S', $this->Ini->field_config['widget9_metric']['format_neg'], $this->Ini->field_config['widget9_metric']['symbol_mon'], $this->Ini->field_config['widget9_metric']['newfmt_neg'], $this->Ini->field_config['widget9_metric']['symbol_neg'], $this->Ini->field_config['widget9_metric']['symbol_fmt']);
...
} // dsb_course_catalog_control

function nm_limpa_str_dsb_course_catalog(&$str)
{
}
