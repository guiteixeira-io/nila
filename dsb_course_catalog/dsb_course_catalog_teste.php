<?php  
  ...
  session_start() ;
  class dsb_course_catalog_form_teste
  {
   function dsb_course_catalog_teste()
   {
...
<html> 
<HEAD>
 <title>dsb_course_catalog</title> 
...
<?php  
  ...
  $path_img     = $path_img . "dsb_course_catalog/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'dsb_course_catalog')
  {
...
?> 
<br> 
<B><FONT SIZE="4">dsb_course_catalog</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="dsb_course_catalog"> 
</form> 
...
<?php
  ...
  $frm_teste = new dsb_course_catalog_form_teste();
  $frm_teste->dsb_course_catalog_teste();
?>
