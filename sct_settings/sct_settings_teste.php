<?php  
  ...
  session_start() ;
  class sct_settings_form_teste
  {
   function sct_settings_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sct_settings/img";
...
?> 
<br> 
<B><FONT SIZE="4">sct_settings</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sct_settings"> 
</form> 
...
<?php
  ...
  $frm_teste = new sct_settings_form_teste();
  $frm_teste->sct_settings_teste();
?>
