<?php
@session_start() ;
$_SESSION['scriptcase']['qry_studyPlane']['sc_process_barr'] = true;
require_once('../qry_studyPlane/index.php');
unset($_SESSION['scriptcase']['qry_studyPlane']['sc_process_barr']);
$ExportCtrl = new qry_studyPlane_export_control;
$ExportCtrl->Export_barr();

class qry_studyPlane_export_control
{
