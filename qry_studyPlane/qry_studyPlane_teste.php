<?php  
  ...
  session_start() ;
  class qry_studyPlane_form_teste
  {
  function qry_studyPlane_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">qry_studyPlane</FONT></B> 
<br> 
<br> 
...
<input type=submit value="qry_studyPlane"> 
</form> 
...
<?php
  ...
  $frm_teste = new qry_studyPlane_form_teste();
  $frm_teste->qry_studyPlane_teste();
?>
