...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____qry_studyPlane"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____qry_studyPlane"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cdt_studyPlane'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_studyPlane']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['qry_studyPlane']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_studyPlane']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['qry_studyPlane']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['qry_studyPlane']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['qry_studyPlane']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['qry_studyPlane']['embutida_filho'] as $ind => $sc_init)
          {
