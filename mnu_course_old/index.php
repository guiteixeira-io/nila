<?php
include_once('mnu_course_old_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['mnu_course_old']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao']        = "nila";
    $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['mnu_course_old']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class mnu_course_old_class
{
  var $Db;
 ...
 function mnu_course_old_menu()
 {
    global $mnu_course_old_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['mnu_course_old']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "mnu_course_old/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('mnu_course_old');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/mnu_course_old_erro.php");
}
include_once(dirname(__FILE__) . "/mnu_course_old_erro.class.php"); 
$this->Erro = new mnu_course_old_erro();
$str_path = substr($_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$mnu_course_old_menuData         = array();
$mnu_course_old_menuData['path'] = array();
$mnu_course_old_menuData['url']  = array();
$mnu_course_old_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $mnu_course_old_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $mnu_course_old_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $mnu_course_old_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $mnu_course_old_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$mnu_course_old_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$mnu_course_old_menuData['url']['web']   = str_replace("\\", '/', $mnu_course_old_menuData['url']['web']);
$mnu_course_old_menuData['path']['root'] = substr($mnu_course_old_menuData['path']['sys'],  0, -1 * strlen($mnu_course_old_menuData['url']['web']));
$mnu_course_old_menuData['path']['app']  = substr($mnu_course_old_menuData['path']['sys'],  0, strrpos($mnu_course_old_menuData['path']['sys'],  '/'));
$mnu_course_old_menuData['path']['link'] = substr($mnu_course_old_menuData['path']['app'],  0, strrpos($mnu_course_old_menuData['path']['app'],  '/'));
$mnu_course_old_menuData['path']['link'] = substr($mnu_course_old_menuData['path']['link'], 0, strrpos($mnu_course_old_menuData['path']['link'], '/')) . '/';
$mnu_course_old_menuData['path']['app'] .= '/';
$mnu_course_old_menuData['url']['app']   = substr($mnu_course_old_menuData['url']['web'],  0, strrpos($mnu_course_old_menuData['url']['web'],  '/'));
$mnu_course_old_menuData['url']['link']  = substr($mnu_course_old_menuData['url']['app'],  0, strrpos($mnu_course_old_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['mnu_course_old']['glo_nm_usa_grupo'] == "S")
{
    $mnu_course_old_menuData['url']['link']  = substr($mnu_course_old_menuData['url']['link'], 0, strrpos($mnu_course_old_menuData['url']['link'], '/'));
}
$mnu_course_old_menuData['url']['link']  .= '/';
$mnu_course_old_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['mnu_course_old']['sc_apl_link'] = $mnu_course_old_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['mnu_course_old']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['mnu_course_old']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['mnu_course_old']['actual_lang']) || $_SESSION['scriptcase']['mnu_course_old']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['mnu_course_old']['actual_lang'] = $this->str_lang;
...
include_once("mnu_course_old_toolbar.php");
...
if ($_SESSION['scriptcase']['mnu_course_old']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "mnu_course_old";
     $_SESSION['scriptcase']['menu_apls']['mnu_course_old'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao']) && $_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_course_old']['glo_nm_perfil']) && $_SESSION['scriptcase']['mnu_course_old']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_course_old']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_course_old']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['mnu_course_old']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['mnu_course_old']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['mnu_course_old']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['mnu_course_old']['init']))
{
    $_SESSION['sc_session'][1]['mnu_course_old']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['mnu_course_old']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_mnu_course_old'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_mnu_course_old'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_mnu_course_old'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['mnu_course_old'] = "on";
} 
if (!isset($_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_course_old']) || $_SESSION['scriptcase']['sc_apl_seg']['mnu_course_old'] != "on"))
{ 
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'], 'nila', 2); 
}
if (isset($_SESSION['scriptcase']['mnu_course_old']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['mnu_course_old']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['mnu_course_old']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['mnu_course_old']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['mnu_course_old']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['mnu_course_old']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['mnu_course_old']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['mnu_course_old']['sc_outra_jan']) && $_SESSION['sc_session'][1]['mnu_course_old']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['mnu_course_old']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'], 'nila'); 
} 
else 
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'mnu_course_old'))
{
    $_SESSION['sc_session'][1]['mnu_course_old']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_mnu_course_old'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$mnu_course_old_menuData['iframe'] = TRUE;
...
/* Itens do Menu */
$_SESSION['scriptcase']['mnu_course_old']['contr_erro'] = 'on';
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_mnu_course_old'];
...
$mnu_course_old_menuData['data'] = array();

if (isset($_SESSION['scriptcase']['sc_def_menu']['mnu_course_old']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['mnu_course_old']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'mnu_course_old');
    $mnu_course_old_menuData['data'] = $str_menu_usu;
}
if (is_file("mnu_course_old_help.txt"))
{
    $Arq_WebHelp = file("mnu_course_old_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $mnu_course_old_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->mnu_course_old_target('_blank') . "",
                    'sc_id'    => "item_Help",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['mnu_course_old']) && !empty($_SESSION['scriptcase']['sc_menu_del']['mnu_course_old']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($mnu_course_old_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['mnu_course_old']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($mnu_course_old_menuData['data'][$i_menu]);
       }
    ...
    $mnu_course_old_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['mnu_course_old']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['mnu_course_old']))
{
    $disable_menu = false;
    foreach ($mnu_course_old_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['mnu_course_old']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $mnu_course_old_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($mnu_course_old_menuData['iframe'])
{
    $mnu_course_old_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $mnu_course_old_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="mnu_course_old_message.js"></script>
...
Iframe_atual = "mnu_course_old_iframe";
...
<?php
 $seq = 0;
 if(isset($mnu_course_old_menuData['data']) && !empty($mnu_course_old_menuData['data']))
 {
   foreach ($mnu_course_old_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($mnu_course_old_menuData['data_vertical']) && !empty($mnu_course_old_menuData['data_vertical']))
 {
   foreach ($mnu_course_old_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'mnu_course_old_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'mnu_course_old'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_mnu_course_old').hide();
    if (str_id == "")
    {
        $('#iframe_mnu_course_old').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="mnu_course_old_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            Iframe_atual = "mnu_course_old_" + Tab_iframes[i] + '_iframe';
...
{
  str_target_sv = "";
  if (str_id != "iframe_mnu_course_old")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("mnu_course_old_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    if (str_target == "mnu_course_old_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "mnu_course_old")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "mnu_course_old" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_mnu_course_old').length)
        $('#iframe_mnu_course_old')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $mnu_course_old_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->mnu_course_old_escreveMenu($mnu_course_old_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $mnu_course_old_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_mnu_course_old" name="mnu_course_old_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "mnu_course_old_pag_ini.php"); ?>"></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Controle de Target */
function mnu_course_old_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function mnu_course_old_target($str_target)
{
    global $mnu_course_old_menuData;
    ...
    elseif ($mnu_course_old_menuData['iframe'])
    {
        return 'mnu_course_old_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $mnu_course_old_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "mnu_course_old_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_course_old_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "mnu_course_old_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_course_old_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->mnu_course_old_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['mnu_course_old']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['mnu_course_old']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['mnu_course_old']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_course_old']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "mnu_course_old") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['mnu_course_old']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_nila'])) {
            $_SESSION['scriptcase']['mnu_course_old']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_nila'];
        }
    }
}
...
$contr_mnu_course_old = new mnu_course_old_class;
$contr_mnu_course_old->mnu_course_old_menu();
