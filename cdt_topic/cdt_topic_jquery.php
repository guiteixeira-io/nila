...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["aula_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["aula_" + iSeqRow] && scEventControl_data["aula_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["aula_" + iSeqRow] && scEventControl_data["aula_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_cdt_topic_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_cdt_topic_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_cdt_topic_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_pai_' + iSeqRow).bind('blur', function() { sc_cdt_topic_pai__onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_cdt_topic_pai__onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_cdt_topic_pai__onfocus(this, iSeqRow) });
  $('#id_sc_field_icone_' + iSeqRow).bind('blur', function() { sc_cdt_topic_icone__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_cdt_topic_icone__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_cdt_topic_icone__onfocus(this, iSeqRow) });
  $('#id_sc_field_descricao_' + iSeqRow).bind('blur', function() { sc_cdt_topic_descricao__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_cdt_topic_descricao__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_cdt_topic_descricao__onfocus(this, iSeqRow) });
  $('#id_sc_field_link_' + iSeqRow).bind('blur', function() { sc_cdt_topic_link__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_cdt_topic_link__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_cdt_topic_link__onfocus(this, iSeqRow) });
  $('#id_sc_field_ordenacao_' + iSeqRow).bind('blur', function() { sc_cdt_topic_ordenacao__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_cdt_topic_ordenacao__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_cdt_topic_ordenacao__onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0_' + iSeqRow).bind('blur', function() { sc_cdt_topic_sc_field_0__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_cdt_topic_sc_field_0__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_cdt_topic_sc_field_0__onfocus(this, iSeqRow) });
  $('#id_sc_field_aula_' + iSeqRow).bind('blur', function() { sc_cdt_topic_aula__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_cdt_topic_aula__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_cdt_topic_aula__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_cdt_topic_id__onblur(oThis, iSeqRow) {
  do_ajax_cdt_topic_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_topic_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_topic_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_topic_pai__onblur(oThis, iSeqRow) {
  do_ajax_cdt_topic_validate_pai_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_topic_pai__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_topic_pai__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_topic_icone__onblur(oThis, iSeqRow) {
  do_ajax_cdt_topic_validate_icone_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_topic_icone__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_topic_icone__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_topic_descricao__onblur(oThis, iSeqRow) {
  do_ajax_cdt_topic_validate_descricao_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_topic_descricao__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_topic_descricao__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_topic_link__onblur(oThis, iSeqRow) {
  do_ajax_cdt_topic_validate_link_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_topic_link__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_topic_link__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_topic_ordenacao__onblur(oThis, iSeqRow) {
  do_ajax_cdt_topic_validate_ordenacao_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_topic_ordenacao__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_topic_ordenacao__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_topic_sc_field_0__onblur(oThis, iSeqRow) {
  do_ajax_cdt_topic_validate_sc_field_0_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_topic_sc_field_0__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_topic_sc_field_0__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_topic_aula__onblur(oThis, iSeqRow) {
  do_ajax_cdt_topic_validate_aula_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_topic_aula__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_topic_aula__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("aula_", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_aula_(row, status);
}
...
function displayChange_field_aula_(row, status) {
    var fieldId;
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'cdt_topic')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
