...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["mnu_course_catalog"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>nila/nila_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>nila/nila_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_course_catalog"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_course_catalog"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($mnu_course_catalog_menuData["data"]) && is_array($mnu_course_catalog_menuData["data"]) && !empty($mnu_course_catalog_menuData["data"]))
    {
        foreach($mnu_course_catalog_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($mnu_course_catalog_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
