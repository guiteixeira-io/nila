...
function displayChange_field_couses(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_sub_studentCourse_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_sub_studentCourse_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_sct_form_edit_users_mob_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_picture" + iSeqRow).fileupload({
    datatype: "json",
    url: "sct_form_edit_users_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'sct_form_edit_users_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
