<?php  
  ...
  session_start() ;
  class sct_form_edit_users_form_teste
  {
   function sct_form_edit_users_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sct_form_edit_users/img";
...
?> 
<br> 
<B><FONT SIZE="4">sct_form_edit_users</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sct_form_edit_users"> 
</form> 
...
<?php
  ...
  $frm_teste = new sct_form_edit_users_form_teste();
  $frm_teste->sct_form_edit_users_teste();
?>
