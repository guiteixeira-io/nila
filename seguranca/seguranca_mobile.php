...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["seguranca"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["seguranca"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["seguranca"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($seguranca_menuData["data"]) && is_array($seguranca_menuData["data"]) && !empty($seguranca_menuData["data"]))
    {
        foreach($seguranca_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($seguranca_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
