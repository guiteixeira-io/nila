<?php
include_once('seguranca_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['seguranca']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['seguranca']['glo_nm_conexao']        = "nila";
    $_SESSION['scriptcase']['seguranca']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['seguranca']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['seguranca']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['seguranca']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['seguranca']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class seguranca_class
{
  var $Db;
 ...
 function seguranca_menu()
 {
    global $seguranca_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['seguranca']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "seguranca/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['seguranca']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('seguranca');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/seguranca_erro.php");
}
include_once(dirname(__FILE__) . "/seguranca_erro.class.php"); 
$this->Erro = new seguranca_erro();
$str_path = substr($_SESSION['scriptcase']['seguranca']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['seguranca']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['seguranca']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$seguranca_menuData         = array();
$seguranca_menuData['path'] = array();
$seguranca_menuData['url']  = array();
$seguranca_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $seguranca_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $seguranca_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $seguranca_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $seguranca_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$seguranca_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$seguranca_menuData['url']['web']   = str_replace("\\", '/', $seguranca_menuData['url']['web']);
$seguranca_menuData['path']['root'] = substr($seguranca_menuData['path']['sys'],  0, -1 * strlen($seguranca_menuData['url']['web']));
$seguranca_menuData['path']['app']  = substr($seguranca_menuData['path']['sys'],  0, strrpos($seguranca_menuData['path']['sys'],  '/'));
$seguranca_menuData['path']['link'] = substr($seguranca_menuData['path']['app'],  0, strrpos($seguranca_menuData['path']['app'],  '/'));
$seguranca_menuData['path']['link'] = substr($seguranca_menuData['path']['link'], 0, strrpos($seguranca_menuData['path']['link'], '/')) . '/';
$seguranca_menuData['path']['app'] .= '/';
$seguranca_menuData['url']['app']   = substr($seguranca_menuData['url']['web'],  0, strrpos($seguranca_menuData['url']['web'],  '/'));
$seguranca_menuData['url']['link']  = substr($seguranca_menuData['url']['app'],  0, strrpos($seguranca_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] == "S")
{
    $seguranca_menuData['url']['link']  = substr($seguranca_menuData['url']['link'], 0, strrpos($seguranca_menuData['url']['link'], '/'));
}
$seguranca_menuData['url']['link']  .= '/';
$seguranca_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['seguranca']['sc_apl_link'] = $seguranca_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['seguranca']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['seguranca']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['seguranca']['actual_lang']) || $_SESSION['scriptcase']['seguranca']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['seguranca']['actual_lang'] = $this->str_lang;
...
include_once("seguranca_toolbar.php");
...
if ($_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "seguranca";
     $_SESSION['scriptcase']['menu_apls']['seguranca'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['seguranca']['glo_nm_conexao']) && $_SESSION['scriptcase']['seguranca']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['seguranca']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['seguranca']['glo_nm_perfil']) && $_SESSION['scriptcase']['seguranca']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['seguranca']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['seguranca']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['seguranca']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['seguranca']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['seguranca']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['seguranca']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['seguranca']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['seguranca']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['seguranca']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['seguranca']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['seguranca']['init']))
{
    $_SESSION['sc_session'][1]['seguranca']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['seguranca']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['seguranca']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_seguranca'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_seguranca'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_seguranca'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
if (!isset($_SESSION['scriptcase']['seguranca']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['seguranca']) || $_SESSION['scriptcase']['sc_apl_seg']['seguranca'] != "on"))
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'seguranca'))
{
    $_SESSION['sc_session'][1]['seguranca']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_seguranca'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$seguranca_menuData['iframe'] = TRUE;
...
/* Itens do Menu */
$_SESSION['scriptcase']['seguranca']['contr_erro'] = 'on';
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_seguranca'];
...
{
    $seguranca_menuData['data'] .= "item_19|.|" . $nm_var_lab[0] . "|seguranca_form_php.php?sc_item_menu=item_19&sc_apl_menu=sct_grid_sec_users&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->seguranca_target('_self') . "|" . "\n";
}
else
{
    $seguranca_menuData['data'] .= "item_19|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']) == "on")
{
    $seguranca_menuData['data'] .= "item_20|.|" . $nm_var_lab[1] . "|seguranca_form_php.php?sc_item_menu=item_20&sc_apl_menu=sct_grid_sec_apps&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->seguranca_target('_self') . "|" . "\n";
}
else
{
    $seguranca_menuData['data'] .= "item_20|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
...
{
    $seguranca_menuData['data'] .= "item_21|.|" . $nm_var_lab[2] . "|seguranca_form_php.php?sc_item_menu=item_21&sc_apl_menu=sct_grid_sec_groups&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->seguranca_target('_self') . "|" . "\n";
}
else
{
    $seguranca_menuData['data'] .= "item_21|.|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
...
{
    $seguranca_menuData['data'] .= "item_28|.|" . $nm_var_lab[3] . "|seguranca_form_php.php?sc_item_menu=item_28&sc_apl_menu=sct_grid_sec_users_groups&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->seguranca_target('_self') . "|" . "\n";
}
else
{
    $seguranca_menuData['data'] .= "item_28|.|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
...
{
    $seguranca_menuData['data'] .= "item_22|.|" . $nm_var_lab[4] . "|seguranca_form_php.php?sc_item_menu=item_22&sc_apl_menu=sct_search_sec_groups&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->seguranca_target('_self') . "|" . "\n";
}
else
{
    $seguranca_menuData['data'] .= "item_22|.|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']) == "on")
{
    $seguranca_menuData['data'] .= "item_23|.|" . $nm_var_lab[5] . "|seguranca_form_php.php?sc_item_menu=item_23&sc_apl_menu=sct_sync_apps&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->seguranca_target('_self') . "|" . "\n";
}
else
{
    $seguranca_menuData['data'] .= "item_23|.|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']) == "on")
{
    $seguranca_menuData['data'] .= "item_29|.|" . $nm_var_lab[6] . "|seguranca_form_php.php?sc_item_menu=item_29&sc_apl_menu=sct_add_2fa&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->seguranca_target('_self') . "|" . "\n";
}
else
{
    $seguranca_menuData['data'] .= "item_29|.|" . $nm_var_lab[6] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']) == "on")
{
    $seguranca_menuData['data'] .= "item_30|.|" . $nm_var_lab[7] . "|seguranca_form_php.php?sc_item_menu=item_30&sc_apl_menu=sct_settings&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->seguranca_target('_self') . "|" . "\n";
}
else
{
    $seguranca_menuData['data'] .= "item_30|.|" . $nm_var_lab[7] . "||||_self|disabled\n";
}
...
$seguranca_menuData['data'] = array();
$str_disabled = "N";
$str_link = "seguranca_form_php.php?sc_item_menu=item_19&sc_apl_menu=sct_grid_sec_users&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $seguranca_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->seguranca_target('_self') . "\"",
        'sc_id'    => "item_19",
...
$str_disabled = "N";
$str_link = "seguranca_form_php.php?sc_item_menu=item_20&sc_apl_menu=sct_grid_sec_apps&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "seguranca_form_php.php?sc_item_menu=item_21&sc_apl_menu=sct_grid_sec_groups&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "seguranca_form_php.php?sc_item_menu=item_28&sc_apl_menu=sct_grid_sec_users_groups&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "seguranca_form_php.php?sc_item_menu=item_22&sc_apl_menu=sct_search_sec_groups&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "seguranca_form_php.php?sc_item_menu=item_23&sc_apl_menu=sct_sync_apps&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "seguranca_form_php.php?sc_item_menu=item_29&sc_apl_menu=sct_add_2fa&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "seguranca_form_php.php?sc_item_menu=item_30&sc_apl_menu=sct_settings&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['seguranca']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['seguranca']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'seguranca');
    $seguranca_menuData['data'] = $str_menu_usu;
}
if (is_file("seguranca_help.txt"))
{
    $Arq_WebHelp = file("seguranca_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $seguranca_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->seguranca_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['seguranca']) && !empty($_SESSION['scriptcase']['sc_menu_del']['seguranca']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($seguranca_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['seguranca']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($seguranca_menuData['data'][$i_menu]);
       }
    ...
    $seguranca_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['seguranca']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['seguranca']))
{
    $disable_menu = false;
    foreach ($seguranca_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['seguranca']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $seguranca_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($seguranca_menuData['iframe'])
{
    $seguranca_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $seguranca_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['seguranca']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="seguranca_message.js"></script>
...
{
  if (str_id != "iframe_seguranca")
  {
      str_id        = str_id.replace("seguranca_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_seguranca', 'seguranca');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_seguranca').length)
        $('#iframe_seguranca')[0].contentWindow.focus();
  }
}
</script>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $seguranca_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->seguranca_escreveMenu($seguranca_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $seguranca_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_seguranca');\" item-href=\"seguranca_form_php.php?sc_item_menu=seguranca&sc_apl_menu=img_menu&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . "\"  item-target=\"seguranca_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "seguranca_pag_ini.php");
} 
?>
      <iframe id="iframe_seguranca" name="seguranca_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_seguranca').click()";
    echo "</script>";
}
...
/* Controle de Target */
function seguranca_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function seguranca_target($str_target)
{
    global $seguranca_menuData;
    ...
    elseif ($seguranca_menuData['iframe'])
    {
        return 'seguranca_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $seguranca_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "seguranca_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "seguranca_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($seguranca_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['seguranca']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->seguranca_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['seguranca']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['seguranca']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['seguranca']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "seguranca") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['seguranca']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['seguranca']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['seguranca']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_nila'])) {
            $_SESSION['scriptcase']['seguranca']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_nila'];
        }
    }
}
...
$contr_seguranca = new seguranca_class;
$contr_seguranca->seguranca_menu();
