<?php  
  ...
  session_start() ;
  class sub_studentCourse_form_teste
  {
   function sub_studentCourse_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sub_studentCourse/img";
...
<?php
  ...
  $frm_teste = new sub_studentCourse_form_teste();
  $frm_teste->sub_studentCourse_teste();
?>
