<?php  
  ...
  session_start() ;
  class cdt_classExam_form_teste
  {
   function cdt_classExam_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cdt_classExam/img";
...
?> 
<br> 
<B><FONT SIZE="4">cdt_classExam</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cdt_classExam"> 
</form> 
...
<?php
  ...
  $frm_teste = new cdt_classExam_form_teste();
  $frm_teste->cdt_classExam_teste();
?>
