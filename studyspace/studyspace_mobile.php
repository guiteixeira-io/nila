...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["studyspace"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["studyspace"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["studyspace"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($studyspace_menuData["data"]) && is_array($studyspace_menuData["data"]) && !empty($studyspace_menuData["data"]))
    {
        foreach($studyspace_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($studyspace_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
