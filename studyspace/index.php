<?php
include_once('studyspace_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['studyspace']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['studyspace']['glo_nm_conexao']        = "nila";
    $_SESSION['scriptcase']['studyspace']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['studyspace']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['studyspace']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['studyspace']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class studyspace_class
{
  var $Db;
 ...
 function studyspace_menu()
 {
    global $studyspace_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['studyspace']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "studyspace/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['studyspace']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('studyspace');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/studyspace_erro.php");
}
include_once(dirname(__FILE__) . "/studyspace_erro.class.php"); 
$this->Erro = new studyspace_erro();
$str_path = substr($_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['studyspace']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$studyspace_menuData         = array();
$studyspace_menuData['path'] = array();
$studyspace_menuData['url']  = array();
$studyspace_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $studyspace_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $studyspace_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $studyspace_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $studyspace_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$studyspace_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$studyspace_menuData['url']['web']   = str_replace("\\", '/', $studyspace_menuData['url']['web']);
$studyspace_menuData['path']['root'] = substr($studyspace_menuData['path']['sys'],  0, -1 * strlen($studyspace_menuData['url']['web']));
$studyspace_menuData['path']['app']  = substr($studyspace_menuData['path']['sys'],  0, strrpos($studyspace_menuData['path']['sys'],  '/'));
$studyspace_menuData['path']['link'] = substr($studyspace_menuData['path']['app'],  0, strrpos($studyspace_menuData['path']['app'],  '/'));
$studyspace_menuData['path']['link'] = substr($studyspace_menuData['path']['link'], 0, strrpos($studyspace_menuData['path']['link'], '/')) . '/';
$studyspace_menuData['path']['app'] .= '/';
$studyspace_menuData['url']['app']   = substr($studyspace_menuData['url']['web'],  0, strrpos($studyspace_menuData['url']['web'],  '/'));
$studyspace_menuData['url']['link']  = substr($studyspace_menuData['url']['app'],  0, strrpos($studyspace_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] == "S")
{
    $studyspace_menuData['url']['link']  = substr($studyspace_menuData['url']['link'], 0, strrpos($studyspace_menuData['url']['link'], '/'));
}
$studyspace_menuData['url']['link']  .= '/';
$studyspace_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['studyspace']['sc_apl_link'] = $studyspace_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['studyspace']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['studyspace']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['studyspace']['actual_lang']) || $_SESSION['scriptcase']['studyspace']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['studyspace']['actual_lang'] = $this->str_lang;
...
include_once("studyspace_toolbar.php");
...
if ($_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "studyspace";
     $_SESSION['scriptcase']['menu_apls']['studyspace'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['studyspace']['glo_nm_conexao']) && $_SESSION['scriptcase']['studyspace']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['studyspace']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['studyspace']['glo_nm_perfil']) && $_SESSION['scriptcase']['studyspace']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['studyspace']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['studyspace']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['studyspace']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['studyspace']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['studyspace']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['studyspace']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['studyspace']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['studyspace']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['studyspace']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['studyspace']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['studyspace']['init']))
{
    $_SESSION['sc_session'][1]['studyspace']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['studyspace']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['studyspace']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_studyspace'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_studyspace'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_studyspace'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['studyspace'] = "on";
} 
if (!isset($_SESSION['scriptcase']['studyspace']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['studyspace']) || $_SESSION['scriptcase']['sc_apl_seg']['studyspace'] != "on"))
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'studyspace'))
{
    $_SESSION['sc_session'][1]['studyspace']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_studyspace'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$studyspace_menuData['iframe'] = TRUE;
...
{
    require($path_apls . $this->tab_grupo[0] . '_lib/_app_data/dsb_studyspace_ini.php');
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dsb_studyspace']))
      {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_course_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_course_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_course']))
        {
...
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/cdt_user_loged_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cdt_user_loged']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['cdt_user_loged'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_retrieve_pswd_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_retrieve_pswd_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_retrieve_pswd']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['sct_retrieve_pswd'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_login_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_login_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_login']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['sct_login'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_studyspace'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['dsb_studyspace']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['dsb_studyspace']) == "on")
{
    $studyspace_menuData['data'] .= "item_7|.|" . $nm_var_lab[0] . "|studyspace_form_php.php?sc_item_menu=item_7&sc_apl_menu=dsb_studyspace&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "|grp__NM__ico__NM__nila-logo30.png|" . $this->studyspace_target('_self') . "|" . "\n";
}
else
{
    $studyspace_menuData['data'] .= "item_7|.|" . $nm_var_lab[0] . "|||grp__NM__ico__NM__nila-logo30.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_course']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_course']) == "on")
{
    $studyspace_menuData['data'] .= "item_1|.|" . $nm_var_lab[1] . "|studyspace_form_php.php?sc_item_menu=item_1&sc_apl_menu=mnu_course&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->studyspace_target('_self') . "|" . "\n";
}
else
{
    $studyspace_menuData['data'] .= "item_1|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
$studyspace_menuData['data'] .= "item_3|.|" . $nm_var_lab[2] . "|studyspace_form_php.php?sc_item_menu=item_3&sc_apl_menu=https://calendar.google.com/calendar/u/0?cid=Y2xhc3Nyb29tMTExMTgzMjExMTQzMjkxODEzODIwQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->studyspace_target('_blank') . "|" . "\n";
$studyspace_menuData['data'] .= "item_4|.|" . $nm_var_lab[3] . "|studyspace_form_php.php?sc_item_menu=item_4&sc_apl_menu=https://keep.google.com/&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->studyspace_target('_blank') . "|" . "\n";
$studyspace_menuData['data'] .= "item_5|.|" . $nm_var_lab[4] . "|studyspace_form_php.php?sc_item_menu=item_5&sc_apl_menu=https://classroom.google.com/c/MjkyOTAwNTc0NjFa?cjc=dwmlkxj&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->studyspace_target('_blank') . "|" . "\n";
$studyspace_menuData['data'] .= "item_6|.|" . $nm_var_lab[5] . "|studyspace_form_php.php?sc_item_menu=item_6&sc_apl_menu=https://mail.google.com/chat/u/0/&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->studyspace_target('_blank') . "|" . "\n";
...
$studyspace_menuData['data'] = array();
$str_disabled = "N";
$str_link = "studyspace_form_php.php?sc_item_menu=item_7&sc_apl_menu=dsb_studyspace&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dsb_studyspace']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['dsb_studyspace']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "grp__NM__ico__NM__nila-logo30.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $studyspace_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->studyspace_target('_self') . "\"",
        'sc_id'    => "item_7",
...
$str_disabled = "N";
$str_link = "studyspace_form_php.php?sc_item_menu=item_1&sc_apl_menu=mnu_course&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_course']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_course']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "studyspace_form_php.php?sc_item_menu=item_3&sc_apl_menu=https://calendar.google.com/calendar/u/0?cid=Y2xhc3Nyb29tMTExMTgzMjExMTQzMjkxODEzODIwQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
...
$studyspace_menuData['data'][] = array(
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " item-target=\"" . $this->studyspace_target('_blank') . "\"",
    'sc_id'    => "item_3",
    'disabled' => $str_disabled,
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "studyspace_form_php.php?sc_item_menu=item_4&sc_apl_menu=https://keep.google.com/&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
...
$studyspace_menuData['data'][] = array(
    ...
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
    'icon_fa'     => "fas fa-sticky-note",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);
$str_disabled = "N";
$str_link = "studyspace_form_php.php?sc_item_menu=item_5&sc_apl_menu=https://classroom.google.com/c/MjkyOTAwNTc0NjFa?cjc=dwmlkxj&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
...
$studyspace_menuData['data'][] = array(
    ...
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
    'icon_fa'     => "fas fa-comments",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);
$str_disabled = "N";
$str_link = "studyspace_form_php.php?sc_item_menu=item_6&sc_apl_menu=https://mail.google.com/chat/u/0/&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
...
$studyspace_menuData['data'][] = array(
    ...
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
    'icon_fa'     => "fas fa-comment-alt",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);

if (isset($_SESSION['scriptcase']['sc_def_menu']['studyspace']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['studyspace']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'studyspace');
    $studyspace_menuData['data'] = $str_menu_usu;
}
if (is_file("studyspace_help.txt"))
{
    $Arq_WebHelp = file("studyspace_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $studyspace_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->studyspace_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['studyspace']) && !empty($_SESSION['scriptcase']['sc_menu_del']['studyspace']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($studyspace_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['studyspace']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($studyspace_menuData['data'][$i_menu]);
       }
    ...
    $studyspace_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['studyspace']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['studyspace']))
{
    $disable_menu = false;
    foreach ($studyspace_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['studyspace']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $studyspace_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($studyspace_menuData['iframe'])
{
    $studyspace_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/grp_Mac_nila-home_<?php echo ($this->menu_orientacao!='vertical')?'hor':'vert'; ?>_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "grp_Mac_nila-home" . '_' . (($this->menu_orientacao!='vertical')?'hor':'vert') . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "grp_Mac_nila-home" . '_' . (($this->menu_orientacao=='horizontal')?'hor':'vert') . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
...
{
    $studyspace_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['studyspace']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="studyspace_message.js"></script>
...
Iframe_atual = "studyspace_iframe";
...
{
  if (str_id != "iframe_studyspace")
  {
      str_id        = str_id.replace("studyspace_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_studyspace', 'studyspace');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_studyspace').length)
        $('#iframe_studyspace')[0].contentWindow.focus();
  }
}
</script>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $studyspace_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->studyspace_escreveMenu($studyspace_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $studyspace_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['dsb_studyspace']) && $_SESSION['scriptcase']['sc_apl_seg']['dsb_studyspace'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_studyspace');\" item-href=\"studyspace_form_php.php?sc_item_menu=studyspace&sc_apl_menu=dsb_studyspace&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . "\"  item-target=\"studyspace_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "studyspace_pag_ini.php");
} 
?>
      <iframe id="iframe_studyspace" name="studyspace_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_studyspace').click()";
    echo "</script>";
}
...
/* Controle de Target */
function studyspace_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function studyspace_target($str_target)
{
    global $studyspace_menuData;
    ...
    elseif ($studyspace_menuData['iframe'])
    {
        return 'studyspace_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $studyspace_menuData, $path_imag_cab)
{
    if(!empty($this->mobile_menu_toolbar) && ($this->force_mobile || ($_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile'])))
    {
        return;
    ...
    <tr id="id_toolbar">
        <td class="scMenuHTableCss" align="right" style="margin:0px; padding:0px;" <?php echo $col_span; ?>>
            ...
            <?php
                ...
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_10", "javascript:", "javascript:", "btn_10", "", "Ajustes", "", "absmiddle", "", "0px", $this->path_botoes, "", "Ajustes", "", "", "", "text_fontawesomeicon", "text_right", "1", "" . $this->studyspace_target('_self') . "", "", "", "", "studyspace", "");
                }

                if ($this->nmgp_botoes['btn_1'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_1", "javascript:", "javascript:", "btn_1", "", "Notificaciones", "", "absmiddle", "", "0px", $this->path_botoes, "", "Notificaciones", "", "", "", "text_fontawesomeicon", "text_right", "1", "" . $this->studyspace_target('_self') . "", "", "", "", "studyspace", "");
                }

                if ($this->nmgp_botoes['btn_2'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_2", "javascript:", "javascript:", "btn_2", "", "Perfil", "", "absmiddle", "", "0px", $this->path_botoes, "", "Perfil", "", "", "__sc_grp__", "text_fontawesomeicon", "text_right", "1", "" . $this->studyspace_target('_self') . "", "", "", "", "studyspace", "");
                    ?>
                            ...
                            <td class="scBtnGrpBackground">
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "studyspace_form_php.php?sc_item_menu=btn_4&sc_apl_menu=cdt_user_loged&sc_apl_link=". urlencode($studyspace_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_4']['disabled']) && strtolower($this->arr_buttons['btn_4']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_4" href="<?php echo $str_href; ?>"   class="scBtnGrpLink" title="Tu" target="<?php echo $this->studyspace_target('_self'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa fas fa-user-circle'></i> Tu</a>
                                  </div>
                              <?php
                              }
                              ?>
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "studyspace_form_php.php?sc_item_menu=btn_11&sc_apl_menu=sct_retrieve_pswd&sc_apl_link=". urlencode($studyspace_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_11']['disabled']) && strtolower($this->arr_buttons['btn_11']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_11" href="<?php echo $str_href; ?>"   class="scBtnGrpLink" title="Cambiar contraseña" target="<?php echo $this->studyspace_target('_self'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa fas fa-key'></i> Cambiar contraseña</a>
                                  </div>
                              <?php
                              }
                              ?>
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "studyspace_form_php.php?sc_item_menu=btn_3&sc_apl_menu=sct_login&sc_apl_link=". urlencode($studyspace_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_3']['disabled']) && strtolower($this->arr_buttons['btn_3']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_3" href="<?php echo $str_href; ?>"   class="scBtnGrpLink" title="Salir" target="<?php echo $this->studyspace_target('_parent'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa fas fa-sign-out-alt'></i> Salir</a>
                                  </div>
                              <?php
                              }
                              ?>
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "studyspace_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "studyspace_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($studyspace_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['studyspace']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->studyspace_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['studyspace']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['studyspace']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['studyspace']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "studyspace") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['studyspace']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['studyspace']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['studyspace']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_nila'])) {
            $_SESSION['scriptcase']['studyspace']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_nila'];
        }
    }
}
...
$contr_studyspace = new studyspace_class;
$contr_studyspace->studyspace_menu();
