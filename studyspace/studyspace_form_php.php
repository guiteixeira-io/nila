...
class studyspace_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['studyspace']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['studyspace']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['studyspace']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['studyspace']['sc_apl_link'];
...
<?php
    exit;
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "studyspace")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("dsb_studyspace") . "/?nm_run_menu=1&nm_apl_menu=studyspace&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['studyspace']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['studyspace'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("dsb_studyspace") . "/?nm_run_menu=1&nm_apl_menu=studyspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_1")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("mnu_course") . "/?nm_run_menu=1&nm_apl_menu=studyspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_3")
      {
          $apl_run  = "https://calendar.google.com/calendar/u/0?cid=Y2xhc3Nyb29tMTExMTgzMjExMTQzMjkxODEzODIwQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20";
          $link_url = true;
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_4")
      {
          $apl_run  = "https://keep.google.com/";
          $link_url = true;
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_5")
      {
          $apl_run  = "https://classroom.google.com/c/MjkyOTAwNTc0NjFa?cjc=dwmlkxj";
          $link_url = true;
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_6")
      {
          $apl_run  = "https://mail.google.com/chat/u/0/";
          $link_url = true;
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_4")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("cdt_user_loged") . "/?nm_run_menu=1&nm_apl_menu=studyspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_11")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("sct_retrieve_pswd") . "/?nm_run_menu=1&nm_apl_menu=studyspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_3")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("sct_login") . "/?script_case_init=" . $_SESSION['sc_session'][1]['studyspace']['init'] . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="studyspace"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "studyspace")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'studyspace', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new studyspace_form_php();
$controle->init();
?>
