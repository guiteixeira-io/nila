<?php  
  ...
  session_start() ;
  class cdt_systemMessages_form_teste
  {
   function cdt_systemMessages_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cdt_systemMessages/img";
...
?> 
<br> 
<B><FONT SIZE="4">cdt_systemMessages</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cdt_systemMessages"> 
</form> 
...
<?php
  ...
  $frm_teste = new cdt_systemMessages_form_teste();
  $frm_teste->cdt_systemMessages_teste();
?>
