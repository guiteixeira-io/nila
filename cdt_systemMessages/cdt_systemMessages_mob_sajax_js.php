  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cdt_systemMessages_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_cdt_systemMessages_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_cdt_systemMessages_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_systemMessages_mob_validate_id(var_id, var_script_case_init, do_ajax_cdt_systemMessages_mob_validate_id_cb);
  } // do_ajax_cdt_systemMessages_mob_validate_id

  function do_ajax_cdt_systemMessages_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_systemMessages_mob_validate_id_cb

  // ---------- Validate page
  function do_ajax_cdt_systemMessages_mob_validate_page()
  {
    var nomeCampo_page = "page";
    var var_page = scAjaxGetFieldText(nomeCampo_page);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_systemMessages_mob_validate_page(var_page, var_script_case_init, do_ajax_cdt_systemMessages_mob_validate_page_cb);
  } // do_ajax_cdt_systemMessages_mob_validate_page

  function do_ajax_cdt_systemMessages_mob_validate_page_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "page";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_systemMessages_mob_validate_page_cb

  // ---------- Validate message
  function do_ajax_cdt_systemMessages_mob_validate_message()
  {
    var nomeCampo_message = "message";
    var var_message = scAjaxGetFieldText(nomeCampo_message);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_systemMessages_mob_validate_message(var_message, var_script_case_init, do_ajax_cdt_systemMessages_mob_validate_message_cb);
  } // do_ajax_cdt_systemMessages_mob_validate_message

  function do_ajax_cdt_systemMessages_mob_validate_message_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "message";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_systemMessages_mob_validate_message_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cdt_systemMessages_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cdt_systemMessages_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_page = scAjaxGetFieldText("page");
    var var_message = scAjaxGetFieldText("message");
    ...
    scAjaxProcOn();
    x_ajax_cdt_systemMessages_mob_submit_form(var_id, var_page, var_message, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cdt_systemMessages_mob_submit_form_cb);
  } // do_ajax_cdt_systemMessages_mob_submit_form

  function do_ajax_cdt_systemMessages_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("page");
      scAjaxHideErrorDisplay("message");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cdt_systemMessages_mob_submit_form_cb_after_alert);
  } // do_ajax_cdt_systemMessages_mob_submit_form_cb
  function do_ajax_cdt_systemMessages_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cdt_systemMessages_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cdt_systemMessages_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cdt_systemMessages_mob_navigate_form, function() {});
    } else {
      perform_ajax_cdt_systemMessages_mob_navigate_form();
    }
  }

  function perform_ajax_cdt_systemMessages_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_cdt_systemMessages_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cdt_systemMessages_mob_navigate_form_cb);
  } // do_ajax_cdt_systemMessages_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_systemMessages_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cdt_systemMessages_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cdt_systemMessages_mob_navigate_form_cb_after_alert);
  } // do_ajax_cdt_systemMessages_mob_navigate_form_cb
  function do_ajax_cdt_systemMessages_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_cdt_systemMessages_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cdt_systemMessages_mob_navigate_form_cb_after_alert

  function sc_hide_cdt_systemMessages_mob_form()
  {
  ...
  ajax_field_list[1] = "page";
  ajax_field_list[2] = "message";
  ...
  var ajax_error_list = {
    ...
    "page": {"label": "Page", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "message": {"label": "Message", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["page"][1] = "page";
  ajax_field_mult["message"][1] = "message";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "page": new Array("hidden_field_label_page", "hidden_field_data_page"),
