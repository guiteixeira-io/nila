<?php  
  ...
  session_start() ;
  class dsb_plane_catalog_form_teste
  {
   function dsb_plane_catalog_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "dsb_plane_catalog/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'dsb_plane_catalog')
  {
...
?> 
<br> 
<B><FONT SIZE="4">dsb_plane_catalog</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="dsb_plane_catalog"> 
</form> 
...
<?php
  ...
  $frm_teste = new dsb_plane_catalog_form_teste();
  $frm_teste->dsb_plane_catalog_teste();
?>
