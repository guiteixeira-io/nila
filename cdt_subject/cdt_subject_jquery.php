...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["pai_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["icone_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  ...
  scEventControl_data["ordenacao_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["sc_field_0_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["curso_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["pai_" + iSeqRow] && scEventControl_data["pai_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["pai_" + iSeqRow] && scEventControl_data["pai_" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["icone_" + iSeqRow] && scEventControl_data["icone_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["icone_" + iSeqRow] && scEventControl_data["icone_" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["descricao_" + iSeqRow] && scEventControl_data["descricao_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["descricao_" + iSeqRow] && scEventControl_data["descricao_" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["ordenacao_" + iSeqRow] && scEventControl_data["ordenacao_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["ordenacao_" + iSeqRow] && scEventControl_data["ordenacao_" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["curso_" + iSeqRow] && scEventControl_data["curso_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["curso_" + iSeqRow] && scEventControl_data["curso_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_cdt_subject_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_cdt_subject_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_cdt_subject_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_pai_' + iSeqRow).bind('blur', function() { sc_cdt_subject_pai__onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_cdt_subject_pai__onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_cdt_subject_pai__onfocus(this, iSeqRow) });
  $('#id_sc_field_icone_' + iSeqRow).bind('blur', function() { sc_cdt_subject_icone__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_cdt_subject_icone__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_cdt_subject_icone__onfocus(this, iSeqRow) });
  $('#id_sc_field_descricao_' + iSeqRow).bind('blur', function() { sc_cdt_subject_descricao__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_cdt_subject_descricao__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_cdt_subject_descricao__onfocus(this, iSeqRow) });
  $('#id_sc_field_link_' + iSeqRow).bind('blur', function() { sc_cdt_subject_link__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_cdt_subject_link__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_cdt_subject_link__onfocus(this, iSeqRow) });
  $('#id_sc_field_ordenacao_' + iSeqRow).bind('blur', function() { sc_cdt_subject_ordenacao__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_cdt_subject_ordenacao__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_cdt_subject_ordenacao__onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0_' + iSeqRow).bind('blur', function() { sc_cdt_subject_sc_field_0__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_cdt_subject_sc_field_0__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_cdt_subject_sc_field_0__onfocus(this, iSeqRow) });
  $('#id_sc_field_curso_' + iSeqRow).bind('blur', function() { sc_cdt_subject_curso__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_cdt_subject_curso__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_cdt_subject_curso__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_cdt_subject_id__onblur(oThis, iSeqRow) {
  do_ajax_cdt_subject_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_subject_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_subject_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_subject_pai__onblur(oThis, iSeqRow) {
  do_ajax_cdt_subject_validate_pai_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_subject_pai__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_subject_pai__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_subject_icone__onblur(oThis, iSeqRow) {
  do_ajax_cdt_subject_validate_icone_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_subject_icone__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_subject_icone__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_subject_descricao__onblur(oThis, iSeqRow) {
  do_ajax_cdt_subject_validate_descricao_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_subject_descricao__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_subject_descricao__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_subject_link__onblur(oThis, iSeqRow) {
  do_ajax_cdt_subject_validate_link_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_subject_link__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_subject_link__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_subject_ordenacao__onblur(oThis, iSeqRow) {
  do_ajax_cdt_subject_validate_ordenacao_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_subject_ordenacao__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_subject_ordenacao__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_subject_sc_field_0__onblur(oThis, iSeqRow) {
  do_ajax_cdt_subject_validate_sc_field_0_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_subject_sc_field_0__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_subject_sc_field_0__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_cdt_subject_curso__onblur(oThis, iSeqRow) {
  do_ajax_cdt_subject_validate_curso_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_cdt_subject_curso__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_cdt_subject_curso__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("pai_", "", status);
	displayChange_field("icone_", "", status);
	displayChange_field("descricao_", "", status);
	displayChange_field("link_", "", status);
	displayChange_field("ordenacao_", "", status);
	displayChange_field("sc_field_0_", "", status);
	displayChange_field("curso_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_id_(row, status);
	displayChange_field_pai_(row, status);
	displayChange_field_icone_(row, status);
	displayChange_field_descricao_(row, status);
	displayChange_field_link_(row, status);
	displayChange_field_ordenacao_(row, status);
	displayChange_field_sc_field_0_(row, status);
	displayChange_field_curso_(row, status);
}
...
function displayChange_field_pai_(row, status) {
    var fieldId;
}

function displayChange_field_icone_(row, status) {
    var fieldId;
}
...
function displayChange_field_ordenacao_(row, status) {
    var fieldId;
}
...
function displayChange_field_curso_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_cdt_subject_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'cdt_subject')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
