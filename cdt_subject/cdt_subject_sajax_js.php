  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cdt_subject" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_cdt_subject_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_cdt_subject_validate_id__cb);
  } // do_ajax_cdt_subject_validate_id_

  function do_ajax_cdt_subject_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_subject_validate_id__cb

  // ---------- Validate pai_
  function do_ajax_cdt_subject_validate_pai_(iNumLinha)
  {
    var nomeCampo_pai_ = "pai_" + iNumLinha;
    var var_pai_ = scAjaxGetFieldText(nomeCampo_pai_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_validate_pai_(var_pai_, iNumLinha, var_script_case_init, do_ajax_cdt_subject_validate_pai__cb);
  } // do_ajax_cdt_subject_validate_pai_

  function do_ajax_cdt_subject_validate_pai__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pai_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pai_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_subject_validate_pai__cb

  // ---------- Validate icone_
  function do_ajax_cdt_subject_validate_icone_(iNumLinha)
  {
    var nomeCampo_icone_ = "icone_" + iNumLinha;
    var var_icone_ = scAjaxGetFieldText(nomeCampo_icone_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_validate_icone_(var_icone_, iNumLinha, var_script_case_init, do_ajax_cdt_subject_validate_icone__cb);
  } // do_ajax_cdt_subject_validate_icone_

  function do_ajax_cdt_subject_validate_icone__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "icone_" + iLineNumber;
    }
    else
    {
      sFieldValid = "icone_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "icone_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "icone_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_subject_validate_icone__cb

  // ---------- Validate descricao_
  function do_ajax_cdt_subject_validate_descricao_(iNumLinha)
  {
    var nomeCampo_descricao_ = "descricao_" + iNumLinha;
    var var_descricao_ = scAjaxGetFieldText(nomeCampo_descricao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_validate_descricao_(var_descricao_, iNumLinha, var_script_case_init, do_ajax_cdt_subject_validate_descricao__cb);
  } // do_ajax_cdt_subject_validate_descricao_

  function do_ajax_cdt_subject_validate_descricao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_subject_validate_descricao__cb

  // ---------- Validate link_
  function do_ajax_cdt_subject_validate_link_(iNumLinha)
  {
    var nomeCampo_link_ = "link_" + iNumLinha;
    var var_link_ = scAjaxGetFieldText(nomeCampo_link_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_validate_link_(var_link_, iNumLinha, var_script_case_init, do_ajax_cdt_subject_validate_link__cb);
  } // do_ajax_cdt_subject_validate_link_

  function do_ajax_cdt_subject_validate_link__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "link_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "link_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_subject_validate_link__cb

  // ---------- Validate ordenacao_
  function do_ajax_cdt_subject_validate_ordenacao_(iNumLinha)
  {
    var nomeCampo_ordenacao_ = "ordenacao_" + iNumLinha;
    var var_ordenacao_ = scAjaxGetFieldText(nomeCampo_ordenacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_validate_ordenacao_(var_ordenacao_, iNumLinha, var_script_case_init, do_ajax_cdt_subject_validate_ordenacao__cb);
  } // do_ajax_cdt_subject_validate_ordenacao_

  function do_ajax_cdt_subject_validate_ordenacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ordenacao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ordenacao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ordenacao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ordenacao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_subject_validate_ordenacao__cb

  // ---------- Validate sc_field_0_
  function do_ajax_cdt_subject_validate_sc_field_0_(iNumLinha)
  {
    var nomeCampo_sc_field_0_ = "sc_field_0_" + iNumLinha;
    var var_sc_field_0_ = scAjaxGetFieldText(nomeCampo_sc_field_0_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_validate_sc_field_0_(var_sc_field_0_, iNumLinha, var_script_case_init, do_ajax_cdt_subject_validate_sc_field_0__cb);
  } // do_ajax_cdt_subject_validate_sc_field_0_

  function do_ajax_cdt_subject_validate_sc_field_0__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_subject_validate_sc_field_0__cb

  // ---------- Validate curso_
  function do_ajax_cdt_subject_validate_curso_(iNumLinha)
  {
    var nomeCampo_curso_ = "curso_" + iNumLinha;
    var var_curso_ = scAjaxGetFieldSelect(nomeCampo_curso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_validate_curso_(var_curso_, iNumLinha, var_script_case_init, do_ajax_cdt_subject_validate_curso__cb);
  } // do_ajax_cdt_subject_validate_curso_

  function do_ajax_cdt_subject_validate_curso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "curso_" + iLineNumber;
    }
    else
    {
      sFieldValid = "curso_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "curso_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "curso_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_subject_validate_curso__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_cdt_subject_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_cdt_subject_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_cdt_subject_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_cdt_subject_add_new_line_cb);
  } // do_ajax_cdt_subject_add_new_line

  function do_ajax_cdt_subject_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_cdt_subject_add_new_line_cb

  // ---------- backup_line
  function do_ajax_cdt_subject_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_subject_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_cdt_subject_backup_line_cb);
  } // do_ajax_cdt_subject_backup_line

  function do_ajax_cdt_subject_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_cdt_subject_backup_line_cb

  function do_ajax_cdt_subject_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_cdt_subject_cancel_insert

  function do_ajax_cdt_subject_cancel_update(iSeqVert)
  {
    do_ajax_cdt_subject_backup_line(iSeqVert);
...
?>
  } // do_ajax_cdt_subject_cancel_update

  function do_ajax_cdt_subject_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_cdt_subject_restore_buttons

  // ---------- table_refresh
  function do_ajax_cdt_subject_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_cdt_subject_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cdt_subject_table_refresh_cb);
  } //  do_ajax_cdt_subject_table_refresh

  function do_ajax_cdt_subject_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_cdt_subject_table_refresh_cb_after_alert);
  } // do_ajax_cdt_subject_table_refresh_cb
  function do_ajax_cdt_subject_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_cdt_subject_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_cdt_subject_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_cdt_subject_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_pai_ = scAjaxGetFieldText("pai_" + iNumLinha);
    var var_icone_ = scAjaxGetFieldText("icone_" + iNumLinha);
    var var_descricao_ = scAjaxGetFieldText("descricao_" + iNumLinha);
    var var_link_ = scAjaxGetFieldText("link_" + iNumLinha);
    var var_ordenacao_ = scAjaxGetFieldText("ordenacao_" + iNumLinha);
    var var_sc_field_0_ = scAjaxGetFieldText("sc_field_0_" + iNumLinha);
    var var_curso_ = scAjaxGetFieldSelect("curso_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_cdt_subject_submit_form(var_id_, var_pai_, var_icone_, var_descricao_, var_link_, var_ordenacao_, var_sc_field_0_, var_curso_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cdt_subject_submit_form_cb);
  } // do_ajax_cdt_subject_submit_form

  function do_ajax_cdt_subject_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("pai_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("icone_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descricao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("link_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ordenacao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sc_field_0_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("curso_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_cdt_subject_submit_form_cb_after_alert);
  } // do_ajax_cdt_subject_submit_form_cb
  function do_ajax_cdt_subject_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cdt_subject_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cdt_subject_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cdt_subject_navigate_form, function() {});
    } else {
      perform_ajax_cdt_subject_navigate_form();
    }
  }

  function perform_ajax_cdt_subject_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_cdt_subject_cancel_insert(sc_cdt_subject_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("pai_" + iNavForm);
      scAjaxHideErrorDisplay("icone_" + iNavForm);
      scAjaxHideErrorDisplay("descricao_" + iNavForm);
      scAjaxHideErrorDisplay("link_" + iNavForm);
      scAjaxHideErrorDisplay("ordenacao_" + iNavForm);
      scAjaxHideErrorDisplay("sc_field_0_" + iNavForm);
      scAjaxHideErrorDisplay("curso_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_cdt_subject_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cdt_subject_navigate_form_cb);
  } // do_ajax_cdt_subject_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_subject']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cdt_subject_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cdt_subject_navigate_form_cb_after_alert);
  } // do_ajax_cdt_subject_navigate_form_cb
  function do_ajax_cdt_subject_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_cdt_subject_navigate_form_cb_after_alert

    function sc_cdt_subject_get_last_line_number()
    {
    ...
    } //sc_cdt_subject_get_last_line_number

  function sc_hide_cdt_subject_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pai_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "icone_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descricao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "link_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ordenacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sc_field_0_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "curso_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["pai_" + iNumLinha] = {"label": "Pai<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["icone_" + iNumLinha] = {"label": "Icone<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["descricao_" + iNumLinha] = {"label": "Modulo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["link_" + iNumLinha] = {"label": "Link<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["ordenacao_" + iNumLinha] = {"label": "Ordenacao<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["sc_field_0_" + iNumLinha] = {"label": "Target<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["curso_" + iNumLinha] = {"label": "Curso<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["pai_"][iNumLinha] = "pai_" + iNumLinha;
    ajax_field_mult["icone_"][iNumLinha] = "icone_" + iNumLinha;
    ajax_field_mult["descricao_"][iNumLinha] = "descricao_" + iNumLinha;
    ajax_field_mult["link_"][iNumLinha] = "link_" + iNumLinha;
    ajax_field_mult["ordenacao_"][iNumLinha] = "ordenacao_" + iNumLinha;
    ajax_field_mult["sc_field_0_"][iNumLinha] = "sc_field_0_" + iNumLinha;
    ajax_field_mult["curso_"][iNumLinha] = "curso_" + iNumLinha;
    ajax_field_id["descricao_" + iNumLinha] = new Array("hidden_field_label_descricao_", "hidden_field_data_descricao_" + iNumLinha);
    ajax_field_id["ordenacao_" + iNumLinha] = new Array("hidden_field_label_ordenacao_", "hidden_field_data_ordenacao_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["pai_" + iNumLinha] = "off";
    ajax_error_count["icone_" + iNumLinha] = "off";
    ajax_error_count["descricao_" + iNumLinha] = "off";
    ajax_error_count["link_" + iNumLinha] = "off";
    ajax_error_count["ordenacao_" + iNumLinha] = "off";
    ajax_error_count["sc_field_0_" + iNumLinha] = "off";
    ajax_error_count["curso_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["pai_" + iNumLinha] = "off";
    ajax_read_only["icone_" + iNumLinha] = "off";
    ajax_read_only["descricao_" + iNumLinha] = "off";
    ajax_read_only["link_" + iNumLinha] = "off";
    ajax_read_only["ordenacao_" + iNumLinha] = "off";
    ajax_read_only["sc_field_0_" + iNumLinha] = "off";
    ajax_read_only["curso_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["pai_" + iNumLinha] = "on";
    ajax_read_only["icone_" + iNumLinha] = "on";
    ajax_read_only["descricao_" + iNumLinha] = "on";
    ajax_read_only["link_" + iNumLinha] = "on";
    ajax_read_only["ordenacao_" + iNumLinha] = "on";
    ajax_read_only["sc_field_0_" + iNumLinha] = "on";
    ajax_read_only["curso_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["pai_" + iNumLinha] = null;
    ajax_error_list["icone_" + iNumLinha] = null;
    ajax_error_list["descricao_" + iNumLinha] = null;
    ajax_error_list["link_" + iNumLinha] = null;
    ajax_error_list["ordenacao_" + iNumLinha] = null;
    ajax_error_list["sc_field_0_" + iNumLinha] = null;
    ajax_error_list["curso_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["pai_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pai_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pai_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pai_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pai_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["icone_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["icone_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["icone_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["icone_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["icone_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["ordenacao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ordenacao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ordenacao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ordenacao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ordenacao_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["curso_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["curso_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["curso_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["curso_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["curso_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pai_'])) ? $this->nmgp_cmp_readonly['pai_'] : 'off';
?>
    scAjaxFieldRead("pai_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['icone_'])) ? $this->nmgp_cmp_readonly['icone_'] : 'off';
?>
    scAjaxFieldRead("icone_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ordenacao_'])) ? $this->nmgp_cmp_readonly['ordenacao_'] : 'off';
?>
    scAjaxFieldRead("ordenacao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['curso_'])) ? $this->nmgp_cmp_readonly['curso_'] : 'off';
?>
    scAjaxFieldRead("curso_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("pai_" + iSeq, "on");
    scAjaxFieldRead("icone_" + iSeq, "on");
    scAjaxFieldRead("descricao_" + iSeq, "on");
    scAjaxFieldRead("link_" + iSeq, "on");
    scAjaxFieldRead("ordenacao_" + iSeq, "on");
    scAjaxFieldRead("sc_field_0_" + iSeq, "on");
    scAjaxFieldRead("curso_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["pai_" + iRow] || "on" == ajax_error_count["icone_" + iRow] || "on" == ajax_error_count["descricao_" + iRow] || "on" == ajax_error_count["link_" + iRow] || "on" == ajax_error_count["ordenacao_" + iRow] || "on" == ajax_error_count["sc_field_0_" + iRow] || "on" == ajax_error_count["curso_" + iRow]))
    {
      ...
      $("#hidden_field_data_pai_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_icone_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descricao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_link_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ordenacao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_field_0_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_curso_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["pai_" + iRow] && "off" == ajax_error_count["icone_" + iRow] && "off" == ajax_error_count["descricao_" + iRow] && "off" == ajax_error_count["link_" + iRow] && "off" == ajax_error_count["ordenacao_" + iRow] && "off" == ajax_error_count["sc_field_0_" + iRow] && "off" == ajax_error_count["curso_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["pai_" + iRow] = "off";
        ajax_error_count["icone_" + iRow] = "off";
        ajax_error_count["descricao_" + iRow] = "off";
        ajax_error_count["link_" + iRow] = "off";
        ajax_error_count["ordenacao_" + iRow] = "off";
        ajax_error_count["sc_field_0_" + iRow] = "off";
        ajax_error_count["curso_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_pai_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_icone_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descricao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_link_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ordenacao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sc_field_0_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_curso_" + iRow).removeClass("scFormErrorLine");
    }
  }
