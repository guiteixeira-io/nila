<?php  
  ...
  session_start() ;
  class cdt_subject_form_teste
  {
   function cdt_subject_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cdt_subject/img";
...
<?php
  ...
  $frm_teste = new cdt_subject_form_teste();
  $frm_teste->cdt_subject_teste();
?>
