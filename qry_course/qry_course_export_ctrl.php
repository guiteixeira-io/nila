<?php
@session_start() ;
$_SESSION['scriptcase']['qry_course']['sc_process_barr'] = true;
require_once('../qry_course/index.php');
unset($_SESSION['scriptcase']['qry_course']['sc_process_barr']);
$ExportCtrl = new qry_course_export_control;
$ExportCtrl->Export_barr();

class qry_course_export_control
{
