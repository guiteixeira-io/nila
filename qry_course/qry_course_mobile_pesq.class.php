...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "pai";$Nm_numeric[] = "ordenacao";$Nm_numeric[] = "id";$Nm_numeric[] = "pai";$Nm_numeric[] = "ordenacao";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pai_cond" name="pai_cond" onChange="nm_campos_between(document.getElementById('id_vis_pai'), this, 'pai')">
      ...
      <br><span id="id_hide_pai"  <?php echo $str_hide_pai?>><INPUT  type="text" id="SC_pai" name="pai" value="<?php echo NM_encode_input($pai) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_icone_cond" name="icone_cond" onChange="nm_campos_between(document.getElementById('id_vis_icone'), this, 'icone')">
      ...
      <br><span id="id_hide_icone"  <?php echo $str_hide_icone?>><?php
      if ($icone != "")
      {
      $icone_look = (is_string($icone) ? substr($this->Db->qstr($icone), 1, -1) : $icone); 
      $nmgp_def_dados = array(); 
