<?php  
  ...
  session_start() ;
  class qry_course_form_teste
  {
  function qry_course_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">qry_course</FONT></B> 
<br> 
<br> 
...
<input type=submit value="qry_course"> 
</form> 
...
<?php
  ...
  $frm_teste = new qry_course_form_teste();
  $frm_teste->qry_course_teste();
?>
