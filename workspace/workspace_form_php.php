...
class workspace_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['workspace']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['workspace']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['workspace']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['workspace']['sc_apl_link'];
...
<?php
    exit;
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "workspace")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("dsb_studyplace") . "/?nm_run_menu=1&nm_apl_menu=workspace&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['workspace']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['workspace'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("dsb_studyspace") . "/?nm_run_menu=1&nm_apl_menu=workspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_1")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("qry_course") . "/?nm_run_menu=1&nm_apl_menu=workspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_3")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("qry_class") . "/?nmgp_outra_jan=true&nm_apl_menu=workspace";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_4")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("qry_summary") . "/?nmgp_outra_jan=true&nm_apl_menu=workspace";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_5")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("qry_classExam") . "/?nmgp_outra_jan=true&nm_apl_menu=workspace";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_8")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("seguranca") . "/?nm_run_menu=1&nm_apl_menu=workspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_6")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("qry_studyPlane") . "/?nmgp_outra_jan=true&nm_apl_menu=workspace";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_4")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("cdt_user_loged") . "/?nm_run_menu=1&nm_apl_menu=workspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_11")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("sct_retrieve_pswd") . "/?nm_run_menu=1&nm_apl_menu=workspace&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_3")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("sct_login") . "/?script_case_init=" . $_SESSION['sc_session'][1]['workspace']['init'] . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="workspace"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "workspace")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'workspace', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new workspace_form_php();
$controle->init();
?>
