...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["workspace"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["workspace"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["workspace"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($workspace_menuData["data"]) && is_array($workspace_menuData["data"]) && !empty($workspace_menuData["data"]))
    {
        foreach($workspace_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($workspace_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
