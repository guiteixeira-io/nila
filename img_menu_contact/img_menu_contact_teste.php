<?php  
  ...
  session_start() ;
  class img_menu_contact_form_teste
  {
  function img_menu_contact_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">img_menu_contact</FONT></B> 
<br> 
<br> 
...
<input type=submit value="img_menu_contact"> 
</form> 
...
<?php
  ...
  $frm_teste = new img_menu_contact_form_teste();
  $frm_teste->img_menu_contact_teste();
?>
