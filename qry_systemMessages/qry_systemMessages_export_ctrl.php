<?php
@session_start() ;
$_SESSION['scriptcase']['qry_systemMessages']['sc_process_barr'] = true;
require_once('../qry_systemMessages/index.php');
unset($_SESSION['scriptcase']['qry_systemMessages']['sc_process_barr']);
$ExportCtrl = new qry_systemMessages_export_control;
$ExportCtrl->Export_barr();

class qry_systemMessages_export_control
{
