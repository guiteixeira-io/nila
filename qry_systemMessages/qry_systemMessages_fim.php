...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____qry_systemMessages"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____qry_systemMessages"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cdt_systemMessages'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_systemMessages']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['qry_systemMessages']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_systemMessages']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['qry_systemMessages']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['qry_systemMessages']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>qry_systemMessages</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['qry_systemMessages']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['qry_systemMessages']['embutida_filho'] as $ind => $sc_init)
          {
