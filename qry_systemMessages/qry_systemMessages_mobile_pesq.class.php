...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_page_cond" name="page_cond" onChange="nm_campos_between(document.getElementById('id_vis_page'), this, 'page')">
      ...
      <br><span id="id_hide_page"  <?php echo $str_hide_page?>><?php
      if ($page != "")
      {
      $page_look = (is_string($page) ? substr($this->Db->qstr($page), 1, -1) : $page); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_message_cond" name="message_cond" onChange="nm_campos_between(document.getElementById('id_vis_message'), this, 'message')">
      ...
      <br><span id="id_hide_message"  <?php echo $str_hide_message?>><INPUT  type="text" id="SC_message" name="message" value="<?php echo NM_encode_input($message) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
