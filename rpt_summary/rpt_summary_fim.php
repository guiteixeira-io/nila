...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____rpt_summary"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____rpt_summary"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_summary']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['rpt_summary']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_summary']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['rpt_summary']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['rpt_summary']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['rpt_summary']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['rpt_summary']['embutida_filho'] as $ind => $sc_init)
          {
