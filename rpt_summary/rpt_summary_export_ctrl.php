<?php
@session_start() ;
$_SESSION['scriptcase']['rpt_summary']['sc_process_barr'] = true;
require_once('../rpt_summary/index.php');
unset($_SESSION['scriptcase']['rpt_summary']['sc_process_barr']);
$ExportCtrl = new rpt_summary_export_control;
$ExportCtrl->Export_barr();

class rpt_summary_export_control
{
