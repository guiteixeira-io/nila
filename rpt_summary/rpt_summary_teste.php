<?php  
  ...
  session_start() ;
  class rpt_summary_form_teste
  {
  function rpt_summary_teste()
  {
...
<?php
  ...
  $frm_teste = new rpt_summary_form_teste();
  $frm_teste->rpt_summary_teste();
?>
