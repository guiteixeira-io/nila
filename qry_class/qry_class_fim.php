...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["nila_____qry_class"]))
   {
      unset($_SESSION['session_sec_aplicacao']["nila_____qry_class"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cdt_class'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_class']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['qry_class']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['qry_class']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['qry_class']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['qry_class']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['qry_class']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['qry_class']['embutida_filho'] as $ind => $sc_init)
          {
