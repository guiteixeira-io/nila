<?php
@session_start() ;
$_SESSION['scriptcase']['qry_class']['sc_process_barr'] = true;
require_once('../qry_class/index.php');
unset($_SESSION['scriptcase']['qry_class']['sc_process_barr']);
$ExportCtrl = new qry_class_export_control;
$ExportCtrl->Export_barr();

class qry_class_export_control
{
