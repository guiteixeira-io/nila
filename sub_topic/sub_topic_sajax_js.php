...
?>
  ...
  // ---------- Validate ordenacao
  function do_ajax_sub_topic_validate_ordenacao()
  {
    var nomeCampo_ordenacao = "ordenacao";
    var var_ordenacao = scAjaxGetFieldText(nomeCampo_ordenacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_topic_validate_ordenacao(var_ordenacao, var_script_case_init, do_ajax_sub_topic_validate_ordenacao_cb);
  } // do_ajax_sub_topic_validate_ordenacao

  function do_ajax_sub_topic_validate_ordenacao_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_topic_validate_ordenacao_cb

  // ---------- Validate tipo
  function do_ajax_sub_topic_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_topic_validate_tipo(var_tipo, var_script_case_init, do_ajax_sub_topic_validate_tipo_cb);
  } // do_ajax_sub_topic_validate_tipo

  function do_ajax_sub_topic_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_topic_validate_tipo_cb

  // ---------- Validate descricao
  function do_ajax_sub_topic_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_topic_validate_descricao(var_descricao, var_script_case_init, do_ajax_sub_topic_validate_descricao_cb);
  } // do_ajax_sub_topic_validate_descricao

  function do_ajax_sub_topic_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_topic_validate_descricao_cb

  // ---------- Validate content
  function do_ajax_sub_topic_validate_content()
  {
    var nomeCampo_content = "content";
    var var_content = scAjaxGetFieldText(nomeCampo_content);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_topic_validate_content(var_content, var_script_case_init, do_ajax_sub_topic_validate_content_cb);
  } // do_ajax_sub_topic_validate_content

  function do_ajax_sub_topic_validate_content_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "content";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_topic_validate_content_cb

  // ---------- Validate summary
  function do_ajax_sub_topic_validate_summary()
  {
    var nomeCampo_summary = "summary";
    var var_summary = scAjaxGetFieldEditorHtml(nomeCampo_summary);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_topic_validate_summary(var_summary, var_script_case_init, do_ajax_sub_topic_validate_summary_cb);
  } // do_ajax_sub_topic_validate_summary

  function do_ajax_sub_topic_validate_summary_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "summary";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_topic_validate_summary_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_sub_topic_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_sub_topic_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_sub_topic_submit_form(var_ordenacao, var_tipo, var_descricao, var_content, var_summary, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sub_topic_submit_form_cb);
  } // do_ajax_sub_topic_submit_form

  function do_ajax_sub_topic_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_sub_topic_submit_form_cb_after_alert);
  } // do_ajax_sub_topic_submit_form_cb
  function do_ajax_sub_topic_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_sub_topic_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_sub_topic_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_sub_topic_navigate_form, function() {});
    } else {
      perform_ajax_sub_topic_navigate_form();
    }
  }

  function perform_ajax_sub_topic_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_sub_topic_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_sub_topic_navigate_form_cb);
  } // do_ajax_sub_topic_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sub_topic']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_sub_topic_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_sub_topic_navigate_form_cb_after_alert);
  } // do_ajax_sub_topic_navigate_form_cb
  function do_ajax_sub_topic_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_sub_topic_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_sub_topic_navigate_form_cb_after_alert

  function sc_hide_sub_topic_form()
  {
