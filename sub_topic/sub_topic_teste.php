<?php  
  ...
  session_start() ;
  class sub_topic_form_teste
  {
   function sub_topic_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sub_topic/img";
...
?> 
<br> 
<B><FONT SIZE="4">sub_topic</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sub_topic"> 
</form> 
...
<?php
  ...
  $frm_teste = new sub_topic_form_teste();
  $frm_teste->sub_topic_teste();
?>
