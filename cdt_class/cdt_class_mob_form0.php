...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_topico'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_topico'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_topico'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_liga_form_btn_nav'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_liga_qtd_reg'] = '5';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_topic_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init'] ]['cdt_class_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'cdt_class_mob_empty.htm' : $this->Ini->link_cdt_topic_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_topico']) && 'nmsc_iframe_liga_cdt_topic_mob' != $this->Ini->sc_lig_target['C_@scinf_topico'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        ...
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['cdt_topic_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_cdt_topic_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_cdt_topic_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
