<?php  
  ...
  session_start() ;
  class cdt_class_form_teste
  {
   function cdt_class_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cdt_class/img";
...
?> 
<br> 
<B><FONT SIZE="4">cdt_class</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cdt_class"> 
</form> 
...
<?php
  ...
  $frm_teste = new cdt_class_form_teste();
  $frm_teste->cdt_class_teste();
?>
