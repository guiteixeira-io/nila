  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cdt_class_mob" == sTestField)
        {
...
?>
  ...
  function do_ajax_cdt_class_mob_validate_ordenacao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_mob_validate_ordenacao(var_ordenacao, var_script_case_init, do_ajax_cdt_class_mob_validate_ordenacao_cb);
  } // do_ajax_cdt_class_mob_validate_ordenacao

  function do_ajax_cdt_class_mob_validate_ordenacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_mob_validate_ordenacao_cb

  // ---------- Validate modulo
  function do_ajax_cdt_class_mob_validate_modulo()
  {
    var nomeCampo_modulo = "modulo";
    var var_modulo = scAjaxGetFieldSelect(nomeCampo_modulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_mob_validate_modulo(var_modulo, var_script_case_init, do_ajax_cdt_class_mob_validate_modulo_cb);
  } // do_ajax_cdt_class_mob_validate_modulo

  function do_ajax_cdt_class_mob_validate_modulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_mob_validate_modulo_cb

  // ---------- Validate descricao
  function do_ajax_cdt_class_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_cdt_class_mob_validate_descricao_cb);
  } // do_ajax_cdt_class_mob_validate_descricao

  function do_ajax_cdt_class_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_cdt_class_mob_validate_topico()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_mob_validate_topico(var_topico, var_script_case_init, do_ajax_cdt_class_mob_validate_topico_cb);
  } // do_ajax_cdt_class_mob_validate_topico

  function do_ajax_cdt_class_mob_validate_topico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "topico";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_mob_validate_topico_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cdt_class_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cdt_class_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cdt_class_mob_submit_form_cb_after_alert);
  } // do_ajax_cdt_class_mob_submit_form_cb
  function do_ajax_cdt_class_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cdt_class_mob_navigate_form, function() {});
    } else {
      perform_ajax_cdt_class_mob_navigate_form();
    }
  }

  function perform_ajax_cdt_class_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cdt_class_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cdt_class_mob_navigate_form_cb_after_alert);
  } // do_ajax_cdt_class_mob_navigate_form_cb
  function do_ajax_cdt_class_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_cdt_class_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cdt_class_mob_navigate_form_cb_after_alert

  function sc_hide_cdt_class_mob_form()
  {
