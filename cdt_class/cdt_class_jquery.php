...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_cdt_class_id_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_cdt_class_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pai' + iSeqRow).bind('blur', function() { sc_cdt_class_pai_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_cdt_class_pai_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_icone' + iSeqRow).bind('blur', function() { sc_cdt_class_icone_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_cdt_class_icone_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_link' + iSeqRow).bind('blur', function() { sc_cdt_class_link_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_cdt_class_link_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_cdt_class_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_cdt_class_sc_field_0_onchange(this, iSeqRow) })
...
function displayChange_field_topico(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_cdt_topic")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_cdt_topic")[0].contentWindow.scRecreateSelect2();
	}
}
