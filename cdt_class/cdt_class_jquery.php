...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["topico" + iSeqRow] && scEventControl_data["topico" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_cdt_class_id_onchange(this, iSeqRow) });
  $('#id_sc_field_pai' + iSeqRow).bind('change', function() { sc_cdt_class_pai_onchange(this, iSeqRow) });
  $('#id_sc_field_icone' + iSeqRow).bind('change', function() { sc_cdt_class_icone_onchange(this, iSeqRow) });
  $('#id_sc_field_descricao' + iSeqRow).bind('blur', function() { sc_cdt_class_descricao_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_cdt_class_descricao_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_cdt_class_descricao_onfocus(this, iSeqRow) });
  $('#id_sc_field_link' + iSeqRow).bind('change', function() { sc_cdt_class_link_onchange(this, iSeqRow) });
  $('#id_sc_field_ordenacao' + iSeqRow).bind('blur', function() { sc_cdt_class_ordenacao_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_cdt_class_ordenacao_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_cdt_class_ordenacao_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('change', function() { sc_cdt_class_sc_field_0_onchange(this, iSeqRow) });
  $('#id_sc_field_curso' + iSeqRow).bind('change', function() { sc_cdt_class_curso_onchange(this, iSeqRow) });
  $('#id_sc_field_modulo' + iSeqRow).bind('blur', function() { sc_cdt_class_modulo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_cdt_class_modulo_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_cdt_class_modulo_onfocus(this, iSeqRow) });
  $('#id_sc_field_summary' + iSeqRow).bind('change', function() { sc_cdt_class_summary_onchange(this, iSeqRow) });
  $('#id_sc_field_topico' + iSeqRow).bind('blur', function() { sc_cdt_class_topico_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_cdt_class_topico_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_cdt_class_topico_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_cdt_class_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_class_pai_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_class_icone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_cdt_class_descricao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_class_descricao_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_cdt_class_link_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_cdt_class_ordenacao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_cdt_class_sc_field_0_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_class_curso_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_class_modulo_onblur(oThis, iSeqRow) {
  do_ajax_cdt_class_validate_modulo();
  scCssBlur(oThis);
}

function sc_cdt_class_modulo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_class_modulo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_cdt_class_summary_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_class_topico_onblur(oThis, iSeqRow) {
  do_ajax_cdt_class_validate_topico();
  scCssBlur(oThis);
}

function sc_cdt_class_topico_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cdt_class_topico_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_1(status) {
	displayChange_field("topico", "", status);
}
...
function displayChange_field_topico(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_sub_topic")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_sub_topic")[0].contentWindow.scRecreateSelect2();
	}
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'cdt_class')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
