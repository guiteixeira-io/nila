...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_cdt_class_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_cdt_class_submit_form(var_ordenacao, var_modulo, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cdt_class_submit_form_cb);
...
?>
  function do_ajax_cdt_class_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_sub_topic"] && "nmsc_iframe_liga_sub_topic" != scMasterDetailIframe["nmsc_iframe_liga_sub_topic"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_sub_topic"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_sub_topic').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_sub_topic').style.height = "1";
        document.getElementById('nmsc_iframe_liga_sub_topic').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["sub_topic"])
    {
      return true;
    }
    return false;
