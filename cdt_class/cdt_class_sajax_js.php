...
?>
  ...
  // ---------- Validate id
  function do_ajax_cdt_class_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_id(var_id, var_script_case_init, do_ajax_cdt_class_validate_id_cb);
  } // do_ajax_cdt_class_validate_id

  function do_ajax_cdt_class_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_id_cb

  // ---------- Validate pai
  function do_ajax_cdt_class_validate_pai()
  {
    var nomeCampo_pai = "pai";
    var var_pai = scAjaxGetFieldText(nomeCampo_pai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_pai(var_pai, var_script_case_init, do_ajax_cdt_class_validate_pai_cb);
  } // do_ajax_cdt_class_validate_pai

  function do_ajax_cdt_class_validate_pai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_pai_cb

  // ---------- Validate icone
  function do_ajax_cdt_class_validate_icone()
  {
    var nomeCampo_icone = "icone";
    var var_icone = scAjaxGetFieldText(nomeCampo_icone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_icone(var_icone, var_script_case_init, do_ajax_cdt_class_validate_icone_cb);
  } // do_ajax_cdt_class_validate_icone

  function do_ajax_cdt_class_validate_icone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icone";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_icone_cb

  // ---------- Validate ordenacao
  function do_ajax_cdt_class_validate_ordenacao()
  {
    var nomeCampo_ordenacao = "ordenacao";
    var var_ordenacao = scAjaxGetFieldText(nomeCampo_ordenacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_ordenacao(var_ordenacao, var_script_case_init, do_ajax_cdt_class_validate_ordenacao_cb);
  } // do_ajax_cdt_class_validate_ordenacao

  function do_ajax_cdt_class_validate_ordenacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_ordenacao_cb

  // ---------- Validate modulo
  function do_ajax_cdt_class_validate_modulo()
  {
    var nomeCampo_modulo = "modulo";
    var var_modulo = scAjaxGetFieldSelect(nomeCampo_modulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_modulo(var_modulo, var_script_case_init, do_ajax_cdt_class_validate_modulo_cb);
  } // do_ajax_cdt_class_validate_modulo

  function do_ajax_cdt_class_validate_modulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_modulo_cb

  // ---------- Validate descricao
  function do_ajax_cdt_class_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_descricao(var_descricao, var_script_case_init, do_ajax_cdt_class_validate_descricao_cb);
  } // do_ajax_cdt_class_validate_descricao

  function do_ajax_cdt_class_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_descricao_cb

  // ---------- Validate link
  function do_ajax_cdt_class_validate_link()
  {
    var nomeCampo_link = "link";
    var var_link = scAjaxGetFieldText(nomeCampo_link);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_link(var_link, var_script_case_init, do_ajax_cdt_class_validate_link_cb);
  } // do_ajax_cdt_class_validate_link

  function do_ajax_cdt_class_validate_link_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "link";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_link_cb

  // ---------- Validate sc_field_0
  function do_ajax_cdt_class_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_cdt_class_validate_sc_field_0_cb);
  } // do_ajax_cdt_class_validate_sc_field_0

  function do_ajax_cdt_class_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_sc_field_0_cb

  // ---------- Validate topico
  function do_ajax_cdt_class_validate_topico()
  {
    var nomeCampo_topico = "topico";
    var var_topico = scAjaxGetFieldText(nomeCampo_topico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cdt_class_validate_topico(var_topico, var_script_case_init, do_ajax_cdt_class_validate_topico_cb);
  } // do_ajax_cdt_class_validate_topico

  function do_ajax_cdt_class_validate_topico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "topico";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cdt_class_validate_topico_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cdt_class_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cdt_class_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_cdt_class_submit_form(var_id, var_pai, var_icone, var_ordenacao, var_modulo, var_descricao, var_link, var_sc_field_0, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cdt_class_submit_form_cb);
  } // do_ajax_cdt_class_submit_form

  function do_ajax_cdt_class_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cdt_class_submit_form_cb_after_alert);
  } // do_ajax_cdt_class_submit_form_cb
  function do_ajax_cdt_class_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cdt_class_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["cdt_topic"] = "off";

  function do_ajax_cdt_class_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cdt_class_navigate_form, function() {});
    } else {
      perform_ajax_cdt_class_navigate_form();
    }
  }

  function perform_ajax_cdt_class_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["cdt_topic"] = "on";
    x_ajax_cdt_class_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cdt_class_navigate_form_cb);
  } // do_ajax_cdt_class_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cdt_class']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cdt_class_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_cdt_topic"] && "nmsc_iframe_liga_cdt_topic" != scMasterDetailIframe["nmsc_iframe_liga_cdt_topic"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_cdt_topic"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_cdt_topic').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_cdt_topic').style.height = "1";
        document.getElementById('nmsc_iframe_liga_cdt_topic').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cdt_class_navigate_form_cb_after_alert);
  } // do_ajax_cdt_class_navigate_form_cb
  function do_ajax_cdt_class_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_cdt_class_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cdt_class_navigate_form_cb_after_alert

  function sc_hide_cdt_class_form()
  {
  ...
  {
    if ("off" == scStatusDetail["cdt_topic"])
    {
      return true;
    }
    return false;
  ...
  var ajax_field_id = {
    ...
    "topico": new Array("hidden_field_label_topico", "hidden_field_data_topico")
  };
