<?php
include_once('mnu_security_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['mnu_security']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['mnu_security']['glo_nm_conexao']        = "nila";
    $_SESSION['scriptcase']['mnu_security']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['mnu_security']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['mnu_security']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class mnu_security_class
{
  var $Db;
 ...
 function mnu_security_menu()
 {
    global $mnu_security_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['mnu_security']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "mnu_security/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['mnu_security']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('mnu_security');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/mnu_security_erro.php");
}
include_once(dirname(__FILE__) . "/mnu_security_erro.class.php"); 
$this->Erro = new mnu_security_erro();
$str_path = substr($_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['mnu_security']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$mnu_security_menuData         = array();
$mnu_security_menuData['path'] = array();
$mnu_security_menuData['url']  = array();
$mnu_security_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $mnu_security_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $mnu_security_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $mnu_security_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $mnu_security_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$mnu_security_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$mnu_security_menuData['url']['web']   = str_replace("\\", '/', $mnu_security_menuData['url']['web']);
$mnu_security_menuData['path']['root'] = substr($mnu_security_menuData['path']['sys'],  0, -1 * strlen($mnu_security_menuData['url']['web']));
$mnu_security_menuData['path']['app']  = substr($mnu_security_menuData['path']['sys'],  0, strrpos($mnu_security_menuData['path']['sys'],  '/'));
$mnu_security_menuData['path']['link'] = substr($mnu_security_menuData['path']['app'],  0, strrpos($mnu_security_menuData['path']['app'],  '/'));
$mnu_security_menuData['path']['link'] = substr($mnu_security_menuData['path']['link'], 0, strrpos($mnu_security_menuData['path']['link'], '/')) . '/';
$mnu_security_menuData['path']['app'] .= '/';
$mnu_security_menuData['url']['app']   = substr($mnu_security_menuData['url']['web'],  0, strrpos($mnu_security_menuData['url']['web'],  '/'));
$mnu_security_menuData['url']['link']  = substr($mnu_security_menuData['url']['app'],  0, strrpos($mnu_security_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] == "S")
{
    $mnu_security_menuData['url']['link']  = substr($mnu_security_menuData['url']['link'], 0, strrpos($mnu_security_menuData['url']['link'], '/'));
}
$mnu_security_menuData['url']['link']  .= '/';
$mnu_security_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['mnu_security']['sc_apl_link'] = $mnu_security_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['mnu_security']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['mnu_security']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['mnu_security']['actual_lang']) || $_SESSION['scriptcase']['mnu_security']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['mnu_security']['actual_lang'] = $this->str_lang;
...
include_once("mnu_security_toolbar.php");
...
if ($_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "mnu_security";
     $_SESSION['scriptcase']['menu_apls']['mnu_security'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['mnu_security']['glo_nm_conexao']) && $_SESSION['scriptcase']['mnu_security']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_security']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_security']['glo_nm_perfil']) && $_SESSION['scriptcase']['mnu_security']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_security']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_security']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['mnu_security']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['mnu_security']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['mnu_security']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['mnu_security']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['mnu_security']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['mnu_security']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['mnu_security']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['mnu_security']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['mnu_security']['init']))
{
    $_SESSION['sc_session'][1]['mnu_security']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['mnu_security']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['mnu_security']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_mnu_security'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_mnu_security'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_mnu_security'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
if (!isset($_SESSION['scriptcase']['mnu_security']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_security']) || $_SESSION['scriptcase']['sc_apl_seg']['mnu_security'] != "on"))
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'mnu_security'))
{
    $_SESSION['sc_session'][1]['mnu_security']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_mnu_security'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$mnu_security_menuData['iframe'] = TRUE;
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_grid_sec_users_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_grid_sec_users_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_grid_sec_apps_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_grid_sec_apps_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_grid_sec_groups_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_grid_sec_groups_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_groups']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_grid_sec_users_groups_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_grid_sec_users_groups_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users_groups']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_search_sec_groups_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_search_sec_groups_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_search_sec_groups']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_sync_apps_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_sync_apps_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_add_2fa_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_add_2fa_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_settings_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sct_settings_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']))
        {
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_mnu_security'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users']) == "on")
{
    $mnu_security_menuData['data'] .= "item_19|.|" . $nm_var_lab[0] . "|mnu_security_form_php.php?sc_item_menu=item_19&sc_apl_menu=sct_grid_sec_users&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->mnu_security_target('_self') . "|" . "\n";
}
else
{
    $mnu_security_menuData['data'] .= "item_19|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']) == "on")
{
    $mnu_security_menuData['data'] .= "item_20|.|" . $nm_var_lab[1] . "|mnu_security_form_php.php?sc_item_menu=item_20&sc_apl_menu=sct_grid_sec_apps&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->mnu_security_target('_self') . "|" . "\n";
}
else
{
    $mnu_security_menuData['data'] .= "item_20|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_groups']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_groups']) == "on")
{
    $mnu_security_menuData['data'] .= "item_21|.|" . $nm_var_lab[2] . "|mnu_security_form_php.php?sc_item_menu=item_21&sc_apl_menu=sct_grid_sec_groups&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->mnu_security_target('_self') . "|" . "\n";
}
else
{
    $mnu_security_menuData['data'] .= "item_21|.|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users_groups']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users_groups']) == "on")
{
    $mnu_security_menuData['data'] .= "item_28|.|" . $nm_var_lab[3] . "|mnu_security_form_php.php?sc_item_menu=item_28&sc_apl_menu=sct_grid_sec_users_groups&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->mnu_security_target('_self') . "|" . "\n";
}
else
{
    $mnu_security_menuData['data'] .= "item_28|.|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_search_sec_groups']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_search_sec_groups']) == "on")
{
    $mnu_security_menuData['data'] .= "item_22|.|" . $nm_var_lab[4] . "|mnu_security_form_php.php?sc_item_menu=item_22&sc_apl_menu=sct_search_sec_groups&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->mnu_security_target('_self') . "|" . "\n";
}
else
{
    $mnu_security_menuData['data'] .= "item_22|.|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']) == "on")
{
    $mnu_security_menuData['data'] .= "item_23|.|" . $nm_var_lab[5] . "|mnu_security_form_php.php?sc_item_menu=item_23&sc_apl_menu=sct_sync_apps&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->mnu_security_target('_self') . "|" . "\n";
}
else
{
    $mnu_security_menuData['data'] .= "item_23|.|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']) == "on")
{
    $mnu_security_menuData['data'] .= "item_29|.|" . $nm_var_lab[6] . "|mnu_security_form_php.php?sc_item_menu=item_29&sc_apl_menu=sct_add_2fa&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->mnu_security_target('_self') . "|" . "\n";
}
else
{
    $mnu_security_menuData['data'] .= "item_29|.|" . $nm_var_lab[6] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']) == "on")
{
    $mnu_security_menuData['data'] .= "item_30|.|" . $nm_var_lab[7] . "|mnu_security_form_php.php?sc_item_menu=item_30&sc_apl_menu=sct_settings&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->mnu_security_target('_self') . "|" . "\n";
}
else
{
    $mnu_security_menuData['data'] .= "item_30|.|" . $nm_var_lab[7] . "||||_self|disabled\n";
}
...
$mnu_security_menuData['data'] = array();
$str_disabled = "N";
$str_link = "mnu_security_form_php.php?sc_item_menu=item_19&sc_apl_menu=sct_grid_sec_users&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_security_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->mnu_security_target('_self') . "\"",
        'sc_id'    => "item_19",
...
$str_disabled = "N";
$str_link = "mnu_security_form_php.php?sc_item_menu=item_20&sc_apl_menu=sct_grid_sec_apps&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "mnu_security_form_php.php?sc_item_menu=item_21&sc_apl_menu=sct_grid_sec_groups&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "mnu_security_form_php.php?sc_item_menu=item_28&sc_apl_menu=sct_grid_sec_users_groups&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "mnu_security_form_php.php?sc_item_menu=item_22&sc_apl_menu=sct_search_sec_groups&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "mnu_security_form_php.php?sc_item_menu=item_23&sc_apl_menu=sct_sync_apps&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "mnu_security_form_php.php?sc_item_menu=item_29&sc_apl_menu=sct_add_2fa&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_add_2fa']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "mnu_security_form_php.php?sc_item_menu=item_30&sc_apl_menu=sct_settings&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sct_settings']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['mnu_security']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['mnu_security']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'mnu_security');
    $mnu_security_menuData['data'] = $str_menu_usu;
}
if (is_file("mnu_security_help.txt"))
{
    $Arq_WebHelp = file("mnu_security_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $mnu_security_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->mnu_security_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['mnu_security']) && !empty($_SESSION['scriptcase']['sc_menu_del']['mnu_security']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($mnu_security_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['mnu_security']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($mnu_security_menuData['data'][$i_menu]);
       }
    ...
    $mnu_security_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['mnu_security']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['mnu_security']))
{
    $disable_menu = false;
    foreach ($mnu_security_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['mnu_security']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $mnu_security_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($mnu_security_menuData['iframe'])
{
    $mnu_security_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $mnu_security_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_security']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="mnu_security_message.js"></script>
...
Iframe_atual = "mnu_security_iframe";
...
{
  if (str_id != "iframe_mnu_security")
  {
      str_id        = str_id.replace("mnu_security_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_mnu_security', 'mnu_security');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_mnu_security').length)
        $('#iframe_mnu_security')[0].contentWindow.focus();
  }
}
</script>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $mnu_security_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->mnu_security_escreveMenu($mnu_security_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $mnu_security_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_mnu_security');\" item-href=\"mnu_security_form_php.php?sc_item_menu=mnu_security&sc_apl_menu=img_menu&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . "\"  item-target=\"mnu_security_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "mnu_security_pag_ini.php");
} 
?>
      <iframe id="iframe_mnu_security" name="mnu_security_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_mnu_security').click()";
    echo "</script>";
}
...
/* Controle de Target */
function mnu_security_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function mnu_security_target($str_target)
{
    global $mnu_security_menuData;
    ...
    elseif ($mnu_security_menuData['iframe'])
    {
        return 'mnu_security_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $mnu_security_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "mnu_security_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "mnu_security_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_security_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_security']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->mnu_security_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['mnu_security']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_security']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_security']['glo_nm_path_imag_temp'] . "/sc_apl_default_nila.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "mnu_security") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['mnu_security']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['mnu_security']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['mnu_security']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_nila'])) {
            $_SESSION['scriptcase']['mnu_security']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_nila'];
        }
    }
}
...
$contr_mnu_security = new mnu_security_class;
$contr_mnu_security->mnu_security_menu();
