<?php  
  ...
  session_start() ;
  class pge_home_form_teste
  {
  function pge_home_teste()
  {
...
<input type=submit value="pge_home"> 
</form> 
...
<?php
  ...
  $frm_teste = new pge_home_form_teste();
  $frm_teste->pge_home_teste();
?>
