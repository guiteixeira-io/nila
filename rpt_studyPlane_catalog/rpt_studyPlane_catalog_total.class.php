...
class rpt_studyPlane_catalog_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['rpt_studyPlane_catalog']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['rpt_studyPlane_catalog']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_studyPlane_catalog']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_studyPlane_catalog']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from (SELECT     id,     name,     description FROM     study_plane LIMIT 1) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_studyPlane_catalog']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_studyPlane_catalog']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_studyPlane_catalog']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_studyPlane_catalog']['contr_total_geral'] = "OK";
   } 
