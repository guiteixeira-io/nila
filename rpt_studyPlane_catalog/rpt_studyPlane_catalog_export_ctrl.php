<?php
@session_start() ;
$_SESSION['scriptcase']['rpt_studyPlane_catalog']['sc_process_barr'] = true;
require_once('../rpt_studyPlane_catalog/index.php');
unset($_SESSION['scriptcase']['rpt_studyPlane_catalog']['sc_process_barr']);
$ExportCtrl = new rpt_studyPlane_catalog_export_control;
$ExportCtrl->Export_barr();

class rpt_studyPlane_catalog_export_control
{
