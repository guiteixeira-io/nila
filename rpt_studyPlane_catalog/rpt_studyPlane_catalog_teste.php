<?php  
  ...
  session_start() ;
  class rpt_studyPlane_catalog_form_teste
  {
  function rpt_studyPlane_catalog_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">rpt_studyPlane_catalog</FONT></B> 
<br> 
<br> 
...
<input type=submit value="rpt_studyPlane_catalog"> 
</form> 
...
<?php
  ...
  $frm_teste = new rpt_studyPlane_catalog_form_teste();
  $frm_teste->rpt_studyPlane_catalog_teste();
?>
