<?php
@session_start() ;
$_SESSION['scriptcase']['sct_grid_sec_groups']['sc_process_barr'] = true;
require_once('../sct_grid_sec_groups/index.php');
unset($_SESSION['scriptcase']['sct_grid_sec_groups']['sc_process_barr']);
$ExportCtrl = new sct_grid_sec_groups_export_control;
$ExportCtrl->Export_barr();

class sct_grid_sec_groups_export_control
{
